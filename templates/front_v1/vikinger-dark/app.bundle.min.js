...
function XM_Accordion(t) {
    var s = {
        ...
        animation: {type: "all", speed: .3, ease: "ease-in-out"},
        paddingAnimation: !1,
        ...
        var n = !0, e = !(d.accordions = []), o = void 0;
        try {
            for (var r, i = t[Symbol.iterator](); !(n = (r = i.next()).done); n = !0) {
                var a = r.value, c = a.querySelector(s.contentSelector);
        ...
        try {
            for (var o, r = function () {
                ...
                c.trigger.addEventListener("click", function () {
                    if (s.linkTriggers) {
                        var t = c.open ? f : y, n = !0, e = !1, o = void 0;
                        try {
...
function XM_Dropdown(t) {
    var c, g = {
        ...
        if (g.controlToggle) {
            ...
            var f = !0, s = !1, u = void 0;
            try {
                for (var y, v = c[Symbol.iterator](); !(f = (y = v.next()).done); f = !0) {
                    var d = y.value, p = d.parentElement.querySelector(g.container);
        ...
        "static" === g.animation.type ? S(t.container, {display: "none"}) : "translate-top" === g.animation.type ? S(t.container, {
            opacity: 0,
            visibility: "hidden",
        ...
        "static" === g.animation.type ? S(t.container, {display: "block"}) : "translate-top" !== g.animation.type && "translate-bottom" !== g.animation.type || S(t.container, {
            opacity: 1,
            visibility: "visible",
            ...
            if (n.ctx.beginPath(), p.roundedCorners) {
                ...
                if (p.clip || p.fill) n.ctx.moveTo(p.width / 2 - r, p.roundedCornerRadius + e), n.ctx.quadraticCurveTo(p.width / 2, 0 + e, p.width / 2 + r, p.roundedCornerRadius + e), n.ctx.lineTo(p.width - e - r, o), n.ctx.quadraticCurveTo(p.width - e, (p.height - v.sideWidth) / 2, p.width - e, (p.height - v.sideWidth) / 2 + r), n.ctx.lineTo(p.width - e, p.height - (p.height - v.sideWidth) / 2 - r), n.ctx.quadraticCurveTo(p.width - e, p.height - (p.height - v.sideWidth) / 2, p.width - e - r, p.height - o), n.ctx.lineTo(p.width / 2 + r, p.height - e - p.roundedCornerRadius), n.ctx.quadraticCurveTo(p.width / 2, p.height - e, p.width / 2 - r, p.height - e - p.roundedCornerRadius), n.ctx.lineTo(0 + e + r, p.height - o), n.ctx.quadraticCurveTo(0 + e, p.height - (p.height - v.sideWidth) / 2, 0 + e, p.height - (p.height - v.sideWidth) / 2 - r), n.ctx.lineTo(0 + e, (p.height - v.sideWidth) / 2 + r), n.ctx.quadraticCurveTo(0 + e, (p.height - v.sideWidth) / 2, 0 + e + r, o), n.ctx.lineTo(p.width / 2 - r, p.roundedCornerRadius + e); else for (; ;) {
                    var a = {x: p.width / 2 - r, y: p.roundedCornerRadius + e}, d = {x: p.width / 2, y: 0 + e},
                        ...
                        u = m(c, l), g = v.lineLength - u - s, f = void 0, x = void 0, w = void 0;
                    if (f = {x: p.width / 2 + r, y: p.roundedCornerRadius + e}, x = {
                        x: p.width - e - r,
                        y: o
                    ...
                    if (f = {x: p.width - e, y: (p.height - v.sideWidth) / 2 + r}, x = {
                        x: p.width - e,
                    ...
                    if (f = {x: p.width - e - r, y: p.height - o}, x = {
                        x: p.width / 2 + r,
...
function XM_Popup(t) {
    ...
    var s = {
        overlay: {
            ...
            opacity: .8,
            closeOnClick: !0,
            animation: {type: "fade", ease: "ease-in-out", speed: .3}
        },
        align: "center",
        sticky: !1,
        offset: {top: 100},
        animation: {type: "fade", ease: "ease-in-out", speed: .3, translateOffset: 100},
        closeOnKey: 27
    }, r = {}, e = function () {
        ...
        var t = window.innerHeight - r.popupContainer.offsetHeight, n = t < 0 ? 0 : t / 2, e = t < 0 ? 0 : t;
...
function XM_ProgressBar(h) {
    ...
    var p = {
        ...
        decimalPoints: 0,
        barTextStyle: {primaryColor: "#fff", secondaryColor: "#363636", font: "bold 10px Exo, sans-serif"}
    }, o = document.createElement("canvas"), r = o.getContext("2d"), l = this, f = function (e) {
    ...
    !function () {
        ...
        }) : p.controlAnimation || E(), void 0 !== p.split) if (void 0 !== p.split.parts) for (var t = (p.width - p.split.gap * (p.split.parts - 1)) / p.split.parts, n = -p.split.gap, i = 0; i < p.split.parts; i++) f({
            width: p.split.gap,
            color: p.split.color,
            offset: n,
            partWidth: t
        }), n += t + p.split.gap; else if (void 0 !== p.split.partItems) {
            var o = 0, r = !0, l = !1, a = void 0;
            try {
...
function XM_Tab(n) {
    var a = {
        ...
        elements: "",
        startOpen: 1,
        animation: {type: "static", speed: .6, easing: "ease-in-out"},
        ...
        "static" === a.animation.type ? S(t, {display: "block"}) : "slide-in-right" === s.animationType && S(t, {
            position: "static",
            transform: "translate(0, 0)",
            opacity: 1,
            visibility: "visible"
        ...
        if ("static" === a.animation.type) S(t, {display: "block"}); else if ("slide-in-right" === a.animation.type) {
        ...
        "static" === a.animation.type ? S(t, {display: "none"}) : "slide-in-right" === a.animation.type && S(t, {
...
function XM_Tooltip(t) {
    var W = {
        ...
        eventHandler: "hover",
        animation: {type: "static", ease: "ease-in-out", speed: .3, translateOffset: 10}
    }, h = {}, i = function () {
        var t = document.querySelectorAll(W.container);
        o(t[0], W.container), h.tooltips = [], t.forEach(function (t) {
            var i = {}, e = document.createElement("div"), a = !0, n = !1, o = void 0;
            try {
...
!function a(o, s, l) {
    ...
    1: [function (e, t, n) {
        ...
        i = this, r = function (i) {
            ...
            var e, d = {
                ...
                for (var n in o) if (o.hasOwnProperty(n)) {
                    ...
                    var i = o[n].channels, r = o[n].labels;
                ...
                o.rgb.hsl = function (e) {
                    var t, n, i = e[0] / 255, r = e[1] / 255, a = e[2] / 255, o = Math.min(i, r, a),
                        s = Math.max(i, r, a), l = s - o;
                    ...
                    var n, i, r, a, o, s = e[0] / 255, l = e[1] / 255, c = e[2] / 255, d = Math.max(s, l, c),
                        u = d - Math.min(s, l, c);
                    ...
                    var t, n, i, r, a, o = e[0] / 360, s = e[1] / 100, l = e[2] / 100;
                    ...
                    var t = e[0], n = e[1] / 100, i = e[2] / 100, r = n, a = Math.max(i, .01);
                    return n *= (i *= 2) <= 1 ? i : 2 - i, r *= a <= 1 ? a : 2 - a, [t, 100 * (0 === i ? 2 * r / (a + r) : 2 * n / (i + n)), 100 * ((i + n) / 2)]
                }, o.hsv.rgb = function (e) {
                    var t = e[0] / 60, n = e[1] / 100, i = e[2] / 100, r = Math.floor(t) % 6, a = t - Math.floor(t),
                        o = 255 * i * (1 - n), s = 255 * i * (1 - n * a), l = 255 * i * (1 - n * (1 - a));
                    switch (i *= 255, r) {
                        case 0:
                            return [i, l, o];
                        case 1:
                    ...
                    var t, n, i, r = e[0], a = e[1] / 100, o = e[2] / 100, s = Math.max(o, .01);
                    return i = (2 - a) * o, n = a * s, [r, 100 * (n = (n /= (t = (2 - a) * s) <= 1 ? t : 2 - t) || 0), 100 * (i /= 2)]
                }, o.hwb.rgb = function (e) {
                    var t, n, i, r, a, o, s, l = e[0] / 360, c = e[1] / 100, d = e[2] / 100, u = c + d;
                    ...
                    var t, n, i, r = e[0] / 100, a = e[1] / 100, o = e[2] / 100;
                    ...
                    var a = Math.pow(n, 3), o = Math.pow(t, 3), s = Math.pow(i, 3);
                    ...
                    var t, n = e[0] / 255, i = e[1] / 255, r = e[2] / 255, a = Math.max(Math.max(n, i), r),
                        o = Math.min(Math.min(n, i), r), s = a - o;
                    ...
                    var r, a = [0, 0, 0], o = t % 1 * 6, s = o % 1, l = 1 - s;
                    switch (Math.floor(o)) {
                        case 0:
                            a[0] = 1, a[1] = s, a[2] = 0;
                            break;
            ...
            function s(e) {
                ...
                for (t[e].distance = 0; n.length;) for (var i = n.pop(), r = Object.keys(c[i]), a = r.length, o = 0; o < a; o++) {
                    var s = r[o], l = t[s];
            ...
            var u = r, o = {
                ...
                getRgba: h, getHsla: f, getRgb: function (e) {
                    var t = h(e);
                    return t && t.slice(0, 3)
                }, getHsl: function (e) {
                    var t = f(e);
                    return t && t.slice(0, 3)
                }, getHwb: g, getAlpha: function (e) {
                    var t = h(e);
                    {
                        if (t) return t[3];
                        if (t = f(e)) return t[3];
                    ...
                    return "rgb(" + n + "%, " + i + "%, " + r + "%)"
                }, percentaString: v, hslString: function (e, t) {
            ...
            M.prototype = {
                isValid: function () {
                    ...
                    var n = this, i = e, r = void 0 === t ? .5 : t, a = 2 * r - 1, o = n.alpha() - i.alpha(),
                        s = (1 + (a * o == -1 ? a : (a + o) / (1 + a * o))) / 2, l = 1 - s;
                    return this.rgb(s * n.red() + l * i.red(), s * n.green() + l * i.green(), s * n.blue() + l * i.blue()).alpha(n.alpha() * r + i.alpha() * (1 - r))
                }, toJSON: function () {
                    return this.rgb()
                }, clone: function () {
                    var e, t, n = new M, i = this.values, r = n.values;
                ...
                var n, i, r = this.values, a = this.spaces, o = this.maxes, s = 1;
            ...
            var w, _ = M, S = {
                noop: function () {
                    ...
                    var r, a, o;
                    if (S.isArray(e)) if (a = e.length, i) for (r = a - 1; 0 <= r; r--) t.call(n, e[r], r); else for (r = 0; r < a; r++) t.call(n, e[r], r); else if (S.isObject(e)) for (a = (o = Object.keys(e)).length, r = 0; r < a; r++) t.call(n, e[o[r]], o[r])
                    ...
                    var i, r, a, o, s, l = S.isArray(t) ? t : [t], c = l.length;
                    ...
                    var n = this, i = e && e.hasOwnProperty("constructor") ? e.constructor : function () {
            ...
            C.easingEffects = k;
            var L = Math.PI, A = L / 180, E = 2 * L, O = L / 2, P = L / 4, D = 2 * L / 3, V = {
                clear: function (e) {
                    e.ctx.clearRect(0, 0, e.width, e.height)
                }, roundedRect: function (e, t, n, i, r, a) {
                    if (a) {
                        var o = Math.min(a, r / 2, i / 2), s = t + o, l = n + o, c = t + i - o, d = n + r - o;
                    ...
                    if (!(isNaN(n) || n <= 0)) {
                        switch (e.beginPath(), t) {
                            ...
                            case"triangle":
                                ...
                                break;
                            case"rectRounded":
                                c = n - (d = .516 * n), s = Math.cos(u + P) * c, l = Math.sin(u + P) * c, e.arc(i - s, r - l, d, u - L, u - O), e.arc(i + l, r - s, d, u - O, u), e.arc(i + s, r + l, d, u, u + O), e.arc(i - l, r + s, d, u + O, u + L), e.closePath();
                                break;
                            case"rect":
                                if (!a) {
                            ...
                            case"cross":
                                ...
                                break;
                            case"star":
                                s = Math.cos(u) * n, l = Math.sin(u) * n, e.moveTo(i - s, r - l), e.lineTo(i + s, r + l), e.moveTo(i + l, r - s), e.lineTo(i - l, r + s), u += P, s = Math.cos(u) * n, l = Math.sin(u) * n, e.moveTo(i - s, r - l), e.lineTo(i + s, r + l), e.moveTo(i + l, r - s), e.lineTo(i - l, r + s);
                                break;
                            case"line":
            ...
            var N = {
                toLineHeight: function (e, t) {
                    ...
                    var t = B.global, n = H(e.fontSize, t.defaultFontSize), i = {
                    ...
                    var r, a, o, s = !0;
                    for (r = 0, a = e.length; r < a; ++r) if (void 0 !== (o = e[r]) && (void 0 !== t && "function" == typeof o && (o = o(t), s = !1), void 0 !== n && C.isArray(o) && (o = o[n], s = !1), void 0 !== o)) return i && !s && (i.cacheable = !1), o
                }
            }, I = {
            ...
            W.extend(X.prototype, {
                _type: void 0, initialize: function () {
                    ...
                    return n && 1 !== e ? (r = r || (t._view = {}), function (e, t, n, i) {
                        ...
                        for (r = 0, a = f.length; r < a; ++r) if (c = n[o = f[r]], t.hasOwnProperty(o) || (t[o] = c), (s = t[o]) !== c && "_" !== o[0]) {
                            if (e.hasOwnProperty(o) || (e[o] = s), (d = typeof c) == typeof (l = e[o])) if ("string" == d) {
            ...
            }, Q = W.options.resolve, ee = ["push", "pop", "shift", "splice", "unshift"];

            function te(t, e) {
                var n = t._chartjs;
                if (n) {
                    var i = n.listeners, r = i.indexOf(e);
                    -1 !== r && i.splice(r, 1), 0 < i.length || (ee.forEach(function (e) {
                        delete t[e]
                    }), delete t._chartjs)
                }
            }
            ...
            W.extend(ne.prototype, {
                ...
                buildOrUpdateElements: function () {
                    var e = this, t = e.getDataset(), n = t.data || (t.data = []);
                ...
                _resolveDatasetElementOptions: function (e, t) {
                    var n, i, r, a, o = this, s = o.chart, l = o._config, c = e.custom || {},
                        d = s.options.elements[o.datasetElementType.prototype._type] || {},
                        u = o._datasetElementOptions, h = {},
                ...
                _resolveDataElementOptions: function (e, t) {
                    ...
                    if (r && !i) return r;
                    var a, o, s, l, c = n.chart, d = n._config,
                        u = c.options.elements[n.dataElementType.prototype._type] || {}, h = n._dataElementOptions,
                        f = {}, g = {chart: c, dataIndex: t, dataset: n.getDataset(), datasetIndex: n.index},
                        p = {cacheable: !i};
                    if (i = i || {}, W.isArray(h)) for (o = 0, s = h.length; o < s; ++o) f[l = h[o]] = Q([i[l], d[l], u[l]], g, t, p); else for (o = 0, s = (a = Object.keys(h)).length; o < s; ++o) f[l = a[o]] = Q([i[l], d[h[l]], d[l], u[l]], g, t, p);
                ...
                _setDatasetHoverStyle: function () {
                    var e, t, n, i, r, a, o = this.getMeta().dataset, s = {};
                    if (o) {
            ...
            function ae(e, t) {
                var n = t.startAngle, i = t.endAngle, r = t.pixelMargin, a = r / t.outerRadius, o = t.x, s = t.y;
            ...
            var se = $.extend({
                _type: "arc", inLabelRange: function (e) {
                    ...
                    if (n) {
                        ...
                        for (; s < r;) r -= re;
                        for (; r < o;) r += re;
                        var l = o <= r && r <= s, c = a >= n.innerRadius && a <= n.outerRadius;
                        return l && c
                    }
                    return !1
            ...
            }), le = W.valueOrDefault, ce = B.global.defaultColor;
            B._set("global", {
                elements: {
                    line: {
                        tension: .4,
            ...
            var de = $.extend({
                _type: "line", draw: function () {
                    var e, t, n, i = this, r = i._view, a = i._chart.ctx, o = r.spanGaps, s = i._children.slice(),
                        l = B.global, c = l.elements.line, d = -1, u = i._loop;
                    if (s.length) {
                        if (i._loop) {
                            for (e = 0; e < s.length; ++e) if (t = W.previousItem(s, e), !s[e]._view.skip && t._view.skip) {
            ...
            }), ue = W.valueOrDefault, he = B.global.defaultColor;
            ...
            var ge = $.extend({
                _type: "point", inRange: function (e, t) {
                ...
                }, inLabelRange: fe, inXRange: fe, inYRange: function (e) {
                    var t = this._view;
                    ...
                    var t = this._view, n = this._chart.ctx, i = t.pointStyle, r = t.rotation, a = t.radius, o = t.x,
                        s = t.y, l = B.global, c = l.defaultColor;
            ...
            function be(e, t, n) {
                var i, r, a, o, s = e.borderWidth, l = function (e) {
            ...
            function xe(e, t, n) {
                var i = null === t, r = null === n, a = !(!e || i && r) && me(e);
            ...
            var Me = $.extend({
                _type: "rectangle", draw: function () {
                    var e = this._chart.ctx, t = this._view, n = function (e) {
                        var t = me(e), n = t.right - t.left, i = t.bottom - t.top, r = be(e, n / 2, i / 2);
                        return {
            ...
            }), we = {}, _e = se, Se = de, Ce = ge, ke = Me;
            we.Arc = _e, we.Line = Se, we.Point = Ce, we.Rectangle = ke;
            var Te = W._deprecated, Le = W.valueOrDefault;

            function Ae(e, t, n) {
                var i, r, a = n.barThickness, o = t.stackCount, s = t.pixels[e],
            ...
            }), B._set("global", {datasets: {bar: {categoryPercentage: .8, barPercentage: .9}}});
            var Ee = ie.extend({
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = i.getMeta(), a = i.getDataset(), o = i._resolveDataElementOptions(e, t);
                ...
                _updateElementGeometry: function (e, t, n, i) {
                    var r = this, a = e._model, o = r._getValueScale(), s = o.getBasePixel(), l = o.isHorizontal(),
                        c = r._ruler || r.getRuler(), d = r.calculateBarValuePixels(r.index, t, i),
                ...
                _getStacks: function (e) {
                    var t, n, i = this._getIndexScale(), r = i._getMatchingVisibleMetas(this._type),
                        a = i.options.stacked, o = r.length, s = [];
                ...
                calculateBarValuePixels: function (e, t, n) {
                    var i, r, a, o, s, l, c, d = this.chart, u = this._getValueScale(), h = u.isHorizontal(),
                        f = d.data.datasets, g = u._getMatchingVisibleMetas(this._type),
                        p = u._parseValue(f[e].data[t]), v = n.minBarLength, m = u.options.stacked,
                        y = this.getMeta().stack, b = void 0 === p.start ? 0 : 0 <= p.max && 0 <= p.min ? p.min : p.max,
                        x = void 0 === p.start ? p.end : 0 <= p.max && 0 <= p.min ? p.max - p.min : p.min - p.max,
                        M = g.length;
                    if (m || void 0 === m && void 0 !== y) for (i = 0; i < M && (r = g[i]).index !== e; ++i) r.stack === y && (a = void 0 === (c = u._parseValue(f[r.index].data[t])).start ? c.end : 0 <= c.min && 0 <= c.max ? c.max : c.min, (p.min < 0 && a < 0 || 0 <= p.max && 0 < a) && (b += a));
                ...
                calculateBarIndexPixels: function (e, t, n, i) {
                    var r = "flex" === i.barThickness ? function (e, t, n) {
                            var i, r = t.pixels, a = r[e], o = 0 < e ? r[e - 1] : null,
                                s = e < r.length - 1 ? r[e + 1] : null, l = n.categoryPercentage;
                            return null === o && (o = a - (null === s ? t.end - t.start : s - a)), null === s && (s = a + a - o), i = a - (a - Math.min(o, s)) / 2 * l, {
                                chunk: Math.abs(s - o) / 2 * l / t.stackCount,
                                ratio: n.barPercentage,
                                start: i
                            }
                        }(t, n, i) : Ae(t, n, i), a = this.getStackIndex(e, this.getMeta().stack),
                ...
                _resolveDataElementOptions: function () {
                    var e = W.extend({}, ie.prototype._resolveDataElementOptions.apply(this, arguments)),
                        t = this._getIndexScale().options, n = this._getValueScale().options;
            ...
            }), Oe = W.valueOrDefault, Pe = W.options.resolve;
            B._set("bubble", {
                hover: {mode: "single"},
                scales: {
            ...
            var De = ie.extend({
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = i.getMeta(), a = e.custom || {}, o = i.getScaleForId(r.xAxisID),
                        s = i.getScaleForId(r.yAxisID), l = i._resolveDataElementOptions(e, t),
                        c = i.getDataset().data[t], d = i.index,
                ...
                setHoverStyle: function (e) {
                    var t = e._model, n = e._options, i = W.getHoverColor;
                    e.$previousStyle = {
                ...
                _resolveDataElementOptions: function (e, t) {
                    var n = this, i = n.chart, r = n.getDataset(), a = e.custom || {}, o = r.data[t] || {},
            ...
            }), Ve = W.valueOrDefault, Re = Math.PI, ze = 2 * Re, Be = Re / 2;
            B._set("doughnut", {
                animation: {animateRotate: !0, animateScale: !1},
                hover: {mode: "single"},
                legendCallback: function (e) {
                    var t, n, i, r = document.createElement("ul"), a = e.data, o = a.datasets, s = a.labels;
                    if (r.setAttribute("class", e.id + "-legend"), o.length) for (n = o[t = 0].data.length; t < n; ++t) (i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = o[0].backgroundColor[t], s[t] && i.appendChild(document.createTextNode(s[t]));
                    return r.outerHTML
                },
                legend: {
                    labels: {
                        generateLabels: function (r) {
                            ...
                            return a.labels.length && a.datasets.length ? a.labels.map(function (e, t) {
                                var n = r.getDatasetMeta(0), i = n.controller.getStyle(t);
                                return {
                                    text: e,
                        ...
                        var n, i, r, a = t.index, o = this.chart;
            ...
            var He = ie.extend({
                ...
                update: function (e) {
                    var t, n, i, r, a = this, o = a.chart, s = o.chartArea, l = o.options, c = 1, d = 1, u = 0, h = 0,
                        f = a.getMeta(), g = f.data, p = l.cutoutPercentage / 100 || 0, v = l.circumference,
                        m = a._getRingWeight(a.index);
                    if (v < ze) {
                        var y = l.rotation % ze, b = (y += Re <= y ? -ze : y < -Re ? ze : 0) + v, x = Math.cos(y),
                            M = Math.sin(y), w = Math.cos(b), _ = Math.sin(b), S = y <= 0 && 0 <= b || ze <= b,
                            C = y <= Be && Be <= b || ze + Be <= b, k = y <= -Be && -Be <= b || Re + Be <= b,
                            T = y === -Re || Re <= b ? -1 : Math.min(x, x * p, w, w * p),
                            L = k ? -1 : Math.min(M, M * p, _, _ * p), A = S ? 1 : Math.max(x, x * p, w, w * p),
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = i.chart, a = r.chartArea, o = r.options, s = o.animation,
                        l = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2, d = o.rotation, u = o.rotation,
                        h = i.getDataset(),
                ...
                getMaxBorderWidth: function (e) {
                    var t, n, i, r, a, o, s, l, c = 0, d = this.chart;
            ...
            }), B._set("global", {datasets: {horizontalBar: {categoryPercentage: .8, barPercentage: .9}}});
            var Ne = Ee.extend({
                _getValueScaleId: function () {
                    return this.getMeta().xAxisID
                }, _getIndexScaleId: function () {
            ...
            }), Ie = W.valueOrDefault, Fe = W.options.resolve, We = W.canvas._isPointInArea;
            ...
            var Ye = ie.extend({
                ...
                update: function (e) {
                    var t, n, i = this, r = i.getMeta(), a = r.dataset, o = r.data || [], s = i.chart.options,
                        l = i._config, c = i._showLine = Ie(l.showLine, s.showLines);
                ...
                updateElement: function (e, t, n) {
                    var i, r, a = this, o = a.getMeta(), s = e.custom || {}, l = a.getDataset(), c = a.index,
                        d = l.data[t], u = a._xScale, h = a._yScale, f = o.dataset._model,
                ...
                _resolveDatasetElementOptions: function (e) {
                    var t = this, n = t._config, i = e.custom || {}, r = t.chart.options, a = r.elements.line,
                ...
                calculatePointY: function (e, t, n) {
                    var i, r, a, o, s, l, c, d = this.chart, u = this._yScale, h = 0, f = 0;
                ...
                updateBezierControlPoints: function () {
                    var e, t, n, i, r = this.chart, a = this.getMeta(), o = a.dataset._model, s = r.chartArea,
                        l = a.data || [];
                ...
                draw: function () {
                    var e, t = this.chart, n = this.getMeta(), i = n.data || [], r = t.chartArea, a = t.canvas, o = 0,
                        s = i.length;
            ...
            var Ue = ie.extend({
                ...
                update: function (e) {
                    var t, n, i, r = this, a = r.getDataset(), o = r.getMeta(), s = r.chart.options.startAngle || 0,
                        l = r._starts = [], c = r._angles = [], d = o.data;
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = i.chart, a = i.getDataset(), o = r.options, s = o.animation, l = r.scale,
                        c = r.data.labels, d = l.xCenter, u = l.yCenter, h = o.startAngle,
                        f = e.hidden ? 0 : l.getDistanceFromCenterForValue(a.data[t]), g = i._starts[t],
                        p = g + (e.hidden ? 0 : i._angles[t]),
                        v = s.animateScale ? 0 : l.getDistanceFromCenterForValue(a.data[t]), m = e._options || {};
                    W.extend(e, {
                        _datasetIndex: i.index,
                        _index: t,
                        _scale: l,
                ...
                setHoverStyle: function (e) {
                    var t = e._model, n = e._options, i = W.getHoverColor, r = W.valueOrDefault;
                    e.$previousStyle = {
                        backgroundColor: t.backgroundColor,
                        borderColor: t.borderColor,
                        borderWidth: t.borderWidth
            ...
            var $e = ie.extend({
                ...
                update: function (e) {
                    var t, n, i = this, r = i.getMeta(), a = r.dataset, o = r.data || [], s = i.chart.scale,
                        l = i._config;
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = e.custom || {}, a = i.getDataset(), o = i.chart.scale,
                        s = o.getPointPositionForValue(t, a.data[t]), l = i._resolveDataElementOptions(e, t),
                        c = i.getMeta().dataset._model, d = n ? o.xCenter : s.x, u = n ? o.yCenter : s.y;
                ...
                _resolveDatasetElementOptions: function () {
                    var e = this._config, t = this.chart.options,
                ...
                updateBezierControlPoints: function () {
                    var e, t, n, i, r = this.getMeta(), a = this.chart.chartArea, o = r.data || [];
            ...
            }), B._set("global", {datasets: {scatter: {showLine: !1}}});
            var Ze = {
                bar: Ee,
                bubble: De,
                doughnut: He,
            ...
            function et(e, i, r, a) {
                ...
                return Je(e, function (e) {
                    if (!r || e.inRange(i.x, i.y)) {
                        var t = e.getCenterPoint(), n = a(i, t);
            ...
            function tt(e) {
                var r = -1 !== e.indexOf("x"), a = -1 !== e.indexOf("y");
                return function (e, t) {
                    var n = r ? Math.abs(e.x - t.x) : 0, i = a ? Math.abs(e.y - t.y) : 0;
            ...
            function nt(e, t, n) {
                var i = Ke(t, e);
                n.axis = n.axis || "x";
                var r = tt(n.axis), a = n.intersect ? Qe(e, i) : et(e, i, !1, r), o = [];
            ...
            var it = {
                modes: {
                    ...
                    }, label: nt, index: nt, dataset: function (e, t, n) {
                        var i = Ke(t, e);
                        n.axis = n.axis || "xy";
                        var r = tt(n.axis), a = n.intersect ? Qe(e, i) : et(e, i, !1, r);
            ...
            function lt(e, t, n) {
                var i, r, a = n.box, o = e.maxPadding;
            ...
            function ut(e, t, n) {
                var i, r, a, o, s = n.padding, l = t.x, c = t.y;
            ...
            var ht, ft = {
                    defaults: {}, addBox: function (e, t) {
                        ...
                        if (n) {
                            var i = n.options.layout || {}, r = W.options.toPadding(i.padding), a = e - r.width,
                                o = t - r.height, s = function (e) {
                                    var t = function (e) {
                                            var t, n, i, r = [];
                                            ...
                                            return r
                                        }(e), n = ot(at(t, "left"), !0), i = ot(at(t, "right")), r = ot(at(t, "top"), !0),
                                        a = ot(at(t, "bottom"));
                                    return {
                                ...
                                }(n.boxes), l = s.vertical, c = s.horizontal, d = Object.freeze({
                                    outerWidth: e,
                                    outerHeight: t,
                                    padding: r,
                                    availableWidth: a,
                            ...
                            }(l.concat(c), d), dt(l, u, d), dt(c, u, d) && dt(l, u, d), function (n) {
                                var i = n.maxPadding;
                ...
                })) && ht.default || ht, pt = "$chartjs", vt = "chartjs-", mt = vt + "size-monitor",
                yt = vt + "render-monitor", bt = vt + "render-animation",
                xt = ["animationstart", "webkitAnimationStart"], Mt = {
            ...
            function wt(e, t) {
                var n = W.getStyle(e, t), i = n && n.match(/^(\d+)(\.\d+)?px$/);
            ...
            function Lt(n, i, r) {
                var a = n[pt] || (n[pt] = {}), t = a.resizer = function (e) {
                    var t = Tt(mt), n = Tt(mt + "-expand"), i = Tt(mt + "-shrink");
                    ...
                    if (a.resizer) {
                        var e = r.options.maintainAspectRatio && n.parentNode, t = e ? e.clientWidth : 0;
                        i(kt("resize", r)), e && e.clientWidth < t && r.canvas && i(kt("resize", r))
                    }
                }));
                !function (t, n) {
                    var e = t[pt] || (t[pt] = {}), i = e.renderProxy = function (e) {
            ...
            function At(e) {
                ...
                delete t.resizer, function (t) {
                    var e = t[pt] || {}, n = e.renderProxy;
                ...
                addEventListener: function (t, e, n) {
                    ...
                    if ("resize" !== e) {
                        ...
                        St(i, e, (r.proxies || (r.proxies = {}))[t.id + "_" + e] = function (e) {
                            n(function (e, t) {
                                var n = Mt[e.type] || e.type, i = W.getRelativePosition(e, t);
            ...
            var Dt = {
                _plugins: [], _cacheId: 0, register: function (e) {
                    ...
                    var i, r, a, o, s, l = this.descriptors(e), c = l.length;
                    ...
                    var i = [], r = [], n = e && e.config || {}, a = n.options && n.options.plugins || {};
            ...
            }, Rt = W.valueOrDefault, zt = W.rtl.getRtlAdapter;
            B._set("global", {
                tooltips: {
                    enabled: !0,
                    custom: null,
            ...
            var Bt = {
                average: function (e) {
                    ...
                    var n, i, r, a = t.x, o = t.y, s = Number.POSITIVE_INFINITY;
                    for (n = 0, i = e.length; n < i; ++n) {
                        var l = e[n];
                        if (l && l.hasValue()) {
                            var c = l.getCenterPoint(), d = W.distanceBetweenPoints(t, c);
                            d < s && (s = d, r = l)
                        }
                    }
                    if (r) {
            ...
            var jt = $.extend({
                initialize: function () {
                    ...
                    var i = this, r = i._options.callbacks, a = [];
                    ...
                    var t, n, i, r, a, o, s, l, c, d, u = this, h = u._options, f = u._model, g = u._model = It(h),
                        p = u._active, v = u._data, m = {xAlign: f.xAlign, yAlign: f.yAlign}, y = {x: f.x, y: f.y},
                    ...
                    if (p.length) {
                        ...
                        h.filter && (_ = _.filter(function (e) {
                            ...
                            var r = e.x, a = e.y, o = e.caretSize, s = e.caretPadding, l = e.cornerRadius, c = n.xAlign,
                                d = n.yAlign, u = o + s, h = l + s;
                            ...
                            var n = e._chart.ctx, i = 2 * t.yPadding, r = 0, a = t.body, o = a.reduce(function (e, t) {
                                return e + t.before.length + t.lines.length + t.after.length
                            }, 0);
                            o += t.beforeBody.length + t.afterBody.length;
                            var s = t.title.length, l = t.footer.length, c = t.titleFontSize, d = t.bodyFontSize,
                                u = t.footerFontSize;
                            ...
                            var n, i, r, a, o, s = e._model, l = e._chart, c = e._chart.chartArea, d = "center",
                                u = "center";
                    ...
                    var i, r, a, o, s, l, c = n.caretSize, d = n.cornerRadius, u = n.xAlign, h = n.yAlign, f = e.x,
                        g = e.y, p = t.width, v = t.height;
                    if ("center" === h) s = g + v / 2, l = "left" === u ? (r = (i = f) - c, a = i, o = s + c, s - c) : (r = (i = f + p) + c, a = i, o = s - c, s + c); else if (a = (i = "left" === u ? (r = f + d + c) - c : "right" === u ? (r = f + p - d - c) - c : (r = n.caretX) - c, r + c), "top" === h) s = (o = g) - c, l = o; else {
                        s = (o = g + v) + c, l = o;
                        var m = a;
                        a = i, i = m
                    }
                    ...
                    var i, r, a, o = t.title, s = o.length;
                    if (s) {
                    ...
                    var r, a, o, s, l, c, d, u, h = e.bodyFontSize, f = e.bodySpacing, g = e._bodyAlign, p = e.body,
                        v = e.displayColors, m = 0, y = v ? Ft(e, "left") : 0, b = zt(e.rtl, e.x, e.width),
                        x = b.textAlign(g);
                    ...
                    var r = t.xAlign, a = t.yAlign, o = e.x, s = e.y, l = i.width, c = i.height, d = t.cornerRadius;
            ...
            W.extend(Jt.prototype, {
                construct: function (e, t) {
                    ...
                    var i = Pt.acquireContext(e, t), r = i && i.canvas, a = r && r.height, o = r && r.width;
                    ...
                    var e = this.options, n = e.scales || {}, t = e.scale;
                    ...
                    var o = this, e = o.options, s = o.scales || {}, t = [], l = Object.keys(s).reduce(function (e, t) {
                        return e[t] = !1, e
                    }, {});
                    e.scales && (t = t.concat((e.scales.xAxes || []).map(function (e) {
                        ...
                        var t = e.options, n = t.id, i = Ut(t.type, e.dtype);
                        Zt(t.position) !== Zt(e.dposition) && (t.position = e.dposition), l[n] = !0;
                        var r = null;
                        if (n in s && s[n].type === i) (r = s[n]).options = t, r.ctx = o.ctx, r.chart = o; else {
                    ...
                    for (e = 0, t = r.length; e < t; e++) {
                        var a = r[e], o = n.getDatasetMeta(e), s = a.type || n.config.type;
                        if (o.type && o.type !== s && (n.destroyDatasetMeta(e), o = n.getDatasetMeta(e)), o.type = s, o.order = a.order || 0, o.index = e, o.controller) o.controller.updateIndex(e), o.controller.linkScales(); else {
                            var l = Ze[o.type];
                        ...
                        if (n && i) {
                            var o = new K({
                                numSteps: i / 16.66, easing: e.easing || n.easing, render: function (e, t) {
                                    var n = W.easing.effects[t.easing], i = t.currentStep, r = i / t.numSteps;
                                    e.draw(n(r), r, i)
            ...
            var nn = {_date: tn}, rn = {
                formatters: {
                    values: function (e) {
                        ...
                        var r = W.log10(Math.abs(i)), a = "";
                        if (0 !== e) if (Math.max(Math.abs(n[0]), Math.abs(n[n.length - 1])) < 1e-4) {
                            var o = W.log10(Math.abs(e)), s = Math.floor(o) - Math.floor(r);
            ...
            }, an = W.isArray, on = W.isNullOrUndef, sn = W.valueOrDefault, ln = W.valueAtIndexOrDefault;

            function cn(e, t, n) {
                var i, r = e.getTicks().length, a = Math.min(t, r - 1), o = e.getPixelForTick(a), s = e._startPixel,
                    l = e._endPixel;
                if (!(n && (i = 1 === r ? Math.max(o - s, l - o) : 0 === t ? (e.getPixelForTick(1) - o) / 2 : (o - e.getPixelForTick(a - 1)) / 2, (o += a < t ? i : -i) < s - 1e-6 || l + 1e-6 < o))) return o
            }

            function dn(e, t, n, i) {
                var r, a, o, s, l, c, d, u, h, f, g, p, v, m = n.length, y = [], b = [], x = [];
                for (r = 0; r < m; ++r) {
            ...
            function vn(e, t, n, i) {
                var r, a, o, s, l = sn(n, 0), c = Math.min(sn(i, e.length), e.length), d = 0;
            ...
            var mn = $.extend({
                ...
                calculateTickRotation: function () {
                    var e, t, n, i, r, a, o, s = this, l = s.options, c = l.ticks, d = s.getTicks().length,
                        u = c.minRotation || 0, h = c.maxRotation, f = u;
                ...
                fit: function () {
                    var e = this, t = e.minSize = {width: 0, height: 0}, n = e.chart, i = e.options, r = i.ticks,
                        a = i.scaleLabel, o = i.gridLines, s = e._isVisible(), l = "bottom" === i.position,
                        c = e.isHorizontal();
                    if (c ? t.width = e.maxWidth : s && (t.width = un(o) + hn(a)), c ? s && (t.height = un(o) + hn(a)) : t.height = e.maxHeight, r.display && s) {
                        var d = gn(r), u = e._getLabelSizes(), h = u.first, f = u.last, g = u.widest, p = u.highest,
                            v = .4 * d.minor.lineHeight, m = r.padding;
                        if (c) {
                            var y = 0 !== e.labelRotation, b = W.toRadians(e.labelRotation), x = Math.cos(b),
                                M = Math.sin(b), w = M * g.width + x * (p.height - (y ? p.offset : 0)) + (y ? 0 : v);
                ...
                _autoSkip: function (e) {
                    var t, n, i, r, a = this.options.ticks, o = this._length,
                        s = a.maxTicksLimit || o / this._tickSize() + 1, l = a.major.enabled ? function (e) {
                            var t, n, i = [];
                            for (t = 0, n = e.length; t < n; t++) e[t].major && i.push(t);
                            return i
                        }(e) : [], c = l.length, d = l[0], u = l[c - 1];
                ...
                _tickSize: function () {
                    var e = this.options.ticks, t = W.toRadians(this.labelRotation), n = Math.abs(Math.cos(t)),
                        i = Math.abs(Math.sin(t)), r = this._getLabelSizes(), a = e.autoSkipPadding || 0,
                ...
                _computeGridLineItems: function (e) {
                    ...
                    var n, i, r, a, o, s, l, c, d, u, h, f, g, p, v, m, y, b = this, x = b.chart, M = b.options,
                        w = M.gridLines, _ = M.position, S = w.offsetGridLines, C = b.isHorizontal(),
                        k = b._ticksToDraw, T = k.length + (S ? 1 : 0), L = un(w), A = [],
                        E = w.drawBorder ? ln(w.lineWidth, 0, 0) : 0, O = E / 2, P = W._alignPixel;
                ...
                _computeLabelItems: function () {
                    var e, t, n, i, r, a, o, s, l, c, d, u, h = this, f = h.options, g = f.ticks, p = f.position,
                        v = g.mirror, m = h.isHorizontal(), y = h._ticksToDraw, b = gn(g), x = g.padding,
                        M = un(f.gridLines), w = -W.toRadians(h.labelRotation), _ = [];
                ...
                _drawGrid: function (e) {
                    ...
                    if (n.display) {
                        var i, r, a, o, s, l = t.ctx, c = t.chart, d = W._alignPixel,
                        ...
                        if (u) {
                            var f, g, p, v, m = u, y = ln(n.lineWidth, h.ticksLength - 1, 1), b = h.borderValue;
                ...
                _drawLabels: function () {
                    ...
                    if (e.options.ticks.display) {
                        ...
                        for (t = 0, i = d.length; t < i; ++t) {
                            if (o = (a = d[t]).font, c.save(), c.translate(a.x, a.y), c.rotate(a.rotation), c.font = o.string, c.fillStyle = o.color, c.textBaseline = "middle", c.textAlign = a.textAlign, s = a.label, l = a.textOffset, an(s)) for (n = 0, r = s.length; n < r; ++n) c.fillText("" + s[n], 0, l), l += o.lineHeight; else c.fillText(s, 0, l);
                            c.restore()
                        }
                    }
                },
                _drawTitle: function () {
                    ...
                    if (i.display) {
                        var r, a, o = sn(i.fontColor, B.global.defaultFontColor), s = W.options._parseFont(i),
                            l = W.options.toPadding(i.padding), c = s.lineHeight / 2, d = n.position, u = 0;
                        if (e.isHorizontal()) r = e.left + e.width / 2, a = "bottom" === d ? e.bottom - c - l.bottom : e.top + c + l.top; else {
                            var h = "left" === d;
            ...
            var yn = mn, bn = W.isNullOrUndef, xn = yn.extend({
                determineDataLimits: function () {
                    var e, t = this, n = t._getLabels(), i = t.options.ticks, r = i.min, a = i.max, o = 0,
                        s = n.length - 1;
            ...
            xn._defaults = Mn;
            var wn = W.noop, _n = W.isNullOrUndef;
            var Sn = yn.extend({
                getRightValue: function (e) {
                    ...
                    if (t.beginAtZero) {
                        var n = W.sign(e.min), i = W.sign(e.max);
                    ...
                    var e = this, t = e.options.ticks, n = e.getTickLimit(), i = {
                        ...
                        var n, i, r, a, o = [], s = e.stepSize, l = s || 1, c = e.maxTicks - 1, d = e.min, u = e.max,
                            h = e.precision, f = t.min, g = t.max, p = W.niceNum((g - f) / c / l) * l;
            ...
            var Ln = Sn.extend({
                determineDataLimits: function () {
                    var e, t, n, i, r = this, a = r.options, o = r.chart.data.datasets,
                        s = r._getMatchingVisibleMetas(), l = a.stacked, c = {}, d = s.length;
            ...
            Ln._defaults = An;
            var En = W.valueOrDefault, On = W.math.log10;
            ...
            var Vn = yn.extend({
                determineDataLimits: function () {
                    var e, t, n, i, r, a, o = this, s = o.options, l = o.chart, c = l.data.datasets,
                        d = o.isHorizontal();
                    ...
                    var h = s.stacked;
                    if (void 0 === h) for (e = 0; e < c.length; e++) if (t = l.getDatasetMeta(e), l.isDatasetVisible(e) && u(t) && void 0 !== t.stack) {
                        h = !0;
                        break
                    }
                    if (s.stacked || h) {
                        ...
                        for (e = 0; e < c.length; e++) {
                            ...
                            if (l.isDatasetVisible(e) && u(t)) for (void 0 === f[g] && (f[g] = []), r = 0, a = (i = c[e].data).length; r < a; r++) {
                                var p = f[g];
                        ...
                        W.each(f, function (e) {
                            if (0 < e.length) {
                                var t = W.min(e), n = W.max(e);
                                o.min = Math.min(o.min, t), o.max = Math.max(o.max, n)
                            }
                        })
                    } else for (e = 0; e < c.length; e++) if (t = l.getDatasetMeta(e), l.isDatasetVisible(e) && u(t)) for (r = 0, a = (i = c[e].data).length; r < a; r++) n = o._parseValue(i[r]), isNaN(n.min) || isNaN(n.max) || t.data[r].hidden || n.min < 0 || n.max < 0 || (o.min = Math.min(n.min, o.min), o.max = Math.max(n.max, o.max), 0 !== n.min && (o.minNotZero = Math.min(n.min, o.minNotZero)));
                    ...
                    var e = this, t = e.options.ticks, n = !e.isHorizontal(), i = {min: Dn(t.min), max: Dn(t.max)},
                        r = e.ticks = function (e, t) {
                            var n, i, r = [], a = En(e.min, Math.pow(10, Math.floor(On(t.min)))),
                                o = Math.floor(On(t.max)), s = Math.ceil(t.max / Math.pow(10, o));
            ...
            Vn._defaults = Rn;
            var zn = W.valueOrDefault, Bn = W.valueAtIndexOrDefault, Hn = W.options.resolve, Nn = {
                display: !0,
                animate: !0,
                position: "chartArea",
            ...
            function Fn(e, t, n, i, r) {
                return e === i || e === r ? {start: t - n / 2, end: t + n / 2} : e < i || r < e ? {
                    start: t - n,
                    end: t
                } : {start: t, end: t + n}
            }
            ...
            function Wn(e, t, n, i) {
                var r, a, o = n.y + i / 2;
                if (W.isArray(t)) for (r = 0, a = t.length; r < a; ++r) e.fillText(t[r], n.x, o), o += i; else e.fillText(t, n.x, o)
            }
            ...
            var Yn = Sn.extend({
                setDimensions: function () {
                    ...
                    var r = this, n = r.chart, a = Number.POSITIVE_INFINITY, o = Number.NEGATIVE_INFINITY;
                    W.each(n.data.datasets, function (e, t) {
                    ...
                    e.display && e.pointLabels.display ? function (e) {
                        var t, n, i, r = W.options._parseFont(e.options.pointLabels),
                            a = {l: 0, r: e.width, t: 0, b: e.height - e.paddingTop}, o = {};
                        ...
                        for (t = 0; t < d; t++) {
                            ...
                            var u = e.getIndexAngle(t), h = W.toDegrees(u) % 360, f = Fn(h, i.x, n.w, 0, 180),
                    ...
                    var i = this, r = t.l / Math.sin(n.l), a = Math.max(t.r - i.width, 0) / Math.sin(n.r),
                        o = -t.t / Math.cos(n.t), s = -Math.max(t.b - (i.height - i.paddingTop), 0) / Math.cos(n.b);
                    ...
                    var r = this, a = r.width - t - r.drawingArea, o = e + r.drawingArea, s = n + r.drawingArea,
                    ...
                    var e, n, t, i = this, r = i.ctx, a = i.options, o = a.gridLines, s = a.angleLines,
                        l = zn(s.lineWidth, o.lineWidth), c = zn(s.color, o.color);
                    if (a.pointLabels.display && function (e) {
                        var t, n, i, r, a = e.ctx, o = e.options, s = o.pointLabels, l = In(o),
                        ...
                        for (var u = e.chart.data.labels.length - 1; 0 <= u; u--) {
                            var h = 0 === u ? l / 2 : 0, f = e.getPointPosition(u, c + h + 5),
                                g = Bn(s.fontColor, u, B.global.defaultFontColor);
                            a.fillStyle = g;
                            var p = e.getIndexAngle(u), v = W.toDegrees(p);
                        ...
                        0 !== t && (n = i.getDistanceFromCenterForValue(i.ticksAsNumbers[t]), function (e, t, n, i) {
                            var r, a = e.ctx, o = t.circular, s = e.chart.data.labels.length, l = Bn(t.color, i - 1),
                                c = Bn(t.lineWidth, i - 1);
                            if ((o || s) && l && c) {
                                if (a.save(), a.strokeStyle = l, a.lineWidth = c, a.setLineDash && (a.setLineDash(t.borderDash || []), a.lineDashOffset = t.borderDashOffset || 0), a.beginPath(), o) a.arc(e.xCenter, e.yCenter, n, 0, 2 * Math.PI); else {
                    ...
                    var n = this, i = n.ctx, r = n.options.ticks;
                    if (r.display) {
                        var a, o, e = n.getIndexAngle(0), s = W.options._parseFont(r),
            ...
            Yn._defaults = Gn;
            var Un = W._deprecated, qn = W.options.resolve, Xn = W.valueOrDefault,
                $n = Number.MIN_SAFE_INTEGER || -9007199254740991, Zn = Number.MAX_SAFE_INTEGER || 9007199254740991,
                Kn = {
            ...
            function ni(e, t, n, i) {
                var r = function (e, t, n) {
                        ...
                        return {lo: a, hi: null}
                    }(e, t, n), a = r.lo ? r.hi ? r.lo : e[e.length - 2] : e[0],
                    o = r.lo ? r.hi ? r.hi : e[e.length - 1] : e[1], s = o[t] - a[t], l = s ? (n - a[t]) / s : 0,
                    c = (o[i] - a[i]) * l;
                return a[i] + c
            }

            function ii(e, t) {
                var n = e._adapter, i = e.options.time, r = i.parser, a = r || i.format, o = t;
            ...
            function oi(e, t, n) {
                var i, r, a = [], o = {}, s = t.length;
                for (i = 0; i < s; ++i) o[r = t[i]] = i, a.push({value: r, major: !1});
                return 0 !== s && n ? function (e, t, n, i) {
                    var r, a, o = e._adapter, s = +o.startOf(t[0].value, i), l = t[t.length - 1].value;
            ...
            var si = yn.extend({
                initialize: function () {
                    ...
                    var e = this.options, t = e.time || (e.time = {}),
                    ...
                    var e, t, n, i, r, a, o, s = this, l = s.chart, c = s._adapter, d = s.options,
                        u = d.time.unit || "day", h = Zn, f = $n, g = [], p = [], v = [], m = s._getLabels();
                    for (e = 0, n = m.length; e < n; ++e) v.push(ri(s, m[e]));
                    for (e = 0, n = (l.data.datasets || []).length; e < n; ++e) if (l.isDatasetVisible(e)) if (r = l.data.datasets[e].data, W.isObject(r[0])) for (p[e] = [], t = 0, i = r.length; t < i; ++t) a = ri(s, r[t]), g.push(a), p[e][t] = a; else p[e] = v.slice(0), o || (g = g.concat(v), o = !0); else p[e] = [];
                    ...
                    var e, t, n, i = this, r = i.min, a = i.max, o = i.options, s = o.ticks, l = o.time,
                        c = i._timestamps, d = [], u = i.getLabelCapacity(r), h = s.source, f = o.distribution;
                    for (c = "data" === h || "auto" === h && "series" === f ? c.data : "labels" === h ? c.labels : function (e, t, n, i) {
                        var r, a = e._adapter, o = e.options, s = o.time, l = s.unit || ai(s.minUnit, t, n, i),
                            c = qn([s.stepSize, s.unitStepSize, 1]), d = "week" === l && s.isoWeekday, u = t, h = [];
                    ...
                    var n = this, i = n._adapter, r = n.chart.data, a = n.options.time,
                        o = r.labels && e < r.labels.length ? r.labels[e] : "", s = r.datasets[t].data[e];
                    ...
                    var r = this._adapter, a = this.options, o = a.time.displayFormats, s = o[this._unit],
                        l = this._majorUnit, c = o[l], d = n[t], u = a.ticks, h = l && c && d && d.major,
                        f = r.format(e, i || (h ? c : s)), g = h ? u.major : u.minor,
                    ...
                    var t = this.options.ticks, n = this.ctx.measureText(e).width,
                        i = W.toRadians(this.isHorizontal() ? t.maxRotation : t.minRotation), r = Math.cos(i),
                        a = Math.sin(i), o = Xn(t.fontSize, B.global.defaultFontSize);
                    return {w: n * r + o * a, h: n * a + o * r}
                }, getLabelWidth: function (e) {
                    return this._getLabelSize(e).w
                }, getLabelCapacity: function (e) {
                    var t = this.options.time, n = t.displayFormats, i = n[t.unit] || n.millisecond,
                        r = this.tickFormatFunction(e, 0, oi(this, [e], this._majorUnit), i), a = this._getLabelSize(r),
            ...
            si._defaults = li;
            var ci = {category: xn, linear: Ln, logarithmic: Vn, radialLinear: Yn, time: si}, di = {
            ...
            } : {}), B._set("global", {plugins: {filler: {propagate: !0}}});
            var ui = {
                dataset: function (e) {
                    var t = e.fill, n = e.chart, i = n.getDatasetMeta(t),
                        r = i && n.isDatasetVisible(t) && i.dataset._children || [], a = r.length || 0;
                    return a ? function (e, t) {
                        return t < a && r[t]._view || null
                    } : null
                }, boundary: function (e) {
                    var n = e.boundary, t = n ? n.x : null, i = n ? n.y : null;
            ...
            function fi(e) {
                return (e.el._scale || {}).getPointPositionForValue ? function (e) {
                    var t, n, i, r, a, o = e.el._scale, s = o.options, l = o.chart.data.labels.length, c = e.fill,
                        d = [];
                    if (!l) return null;
                    ...
                    var t, n = e.el._model || {}, i = e.el._scale || {}, r = e.fill, a = null;
            ...
            function vi(e, t, n, i, r) {
                ...
                if (i && r) {
                    ...
                    if (void 0 === n[0].angle) for (e.lineTo(n[r - 1].x, n[r - 1].y), a = r - 1; 0 < a; --a) W.canvas.lineTo(e, n[a], n[a - 1], !0); else for (o = n[0].cx, s = n[0].cy, l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)), a = r - 1; 0 < a; --a) e.arc(o, s, l, n[a].angle, n[a - 1].angle, !0)
                }
            }

            function mi(e, t, n, i, r, a) {
                var o, s, l, c, d, u, h, f, g = t.length, p = i.spanGaps, v = [], m = [], y = 0, b = 0;
            ...
            var yi = {
                id: "filler", afterDatasetsUpdate: function (e, t) {
                    var n, i, r, a, o, s, l, c = (e.data.datasets || []).length, d = t.propagate, u = [];
                    ...
                    var t, n, i, r, a, o, s, l = e._getSortedVisibleDatasetMetas(), c = e.ctx;
            ...
            }, bi = W.rtl.getRtlAdapter, xi = W.noop, Mi = W.valueOrDefault;
                ...
                legend: {
                    ...
                    labels: {
                        boxWidth: 40, padding: 10, generateLabels: function (n) {
                            var i = n.data.datasets, e = n.options.legend || {}, r = e.labels && e.labels.usePointStyle;
                    ...
                    var t, n, i, r = document.createElement("ul"), a = e.data.datasets;
            ...
            var _i = $.extend({
                initialize: function (e) {
                ...
                }, beforeUpdate: xi, update: function (e, t, n) {
                    var i = this;
                ...
                }, afterUpdate: xi, beforeSetDimensions: xi, setDimensions: function () {
                    var e = this;
                ...
                }, afterSetDimensions: xi, beforeBuildLabels: xi, buildLabels: function () {
                    var t = this, n = t.options.labels || {}, e = W.callback(n.generateLabels, [t.chart], t) || [];
                    n.filter && (e = e.filter(function (e) {
                        return n.filter(e, t.chart.data)
                    })), t.options.reverse && e.reverse(), t.legendItems = e
                }, afterBuildLabels: xi, beforeFit: xi, fit: function () {
                    var e = this, t = e.options, i = t.labels, n = t.display, r = e.ctx, a = W.options._parseFont(i),
                        o = a.size, s = e.legendHitBoxes = [], l = e.minSize, c = e.isHorizontal();
                    if (c ? (l.width = e.maxWidth, l.height = n ? 10 : 0) : (l.width = n ? 10 : 0, l.height = e.maxHeight), n) {
                        if (r.font = a.string, c) {
                            var d = e.lineWidths = [0], u = 0;
                            ...
                            var h = i.padding, f = e.columnWidths = [], g = e.columnHeights = [], p = i.padding, v = 0,
                                m = 0;
                ...
                }, afterFit: xi, isHorizontal: function () {
                    return "top" === this.options.position || "bottom" === this.options.position
                }, draw: function () {
                    var s = this, n = s.options, l = n.labels, e = B.global, c = e.defaultColor, d = e.elements.line,
                        u = s.height, h = s.columnHeights, f = s.width, g = s.lineWidths;
                    if (n.display) {
                        var p, v = bi(n.rtl, s.left, s.minSize.width), m = s.ctx,
                            t = Mi(l.fontColor, e.defaultFontColor), i = W.options._parseFont(l), y = i.size;
                        m.textAlign = v.textAlign("left"), m.textBaseline = "middle", m.lineWidth = .5, m.strokeStyle = t, m.fillStyle = t, m.font = i.string;
                        var b = wi(l, y), x = s.legendHitBoxes, M = function (e, t) {
                            switch (n.align) {
                                case"start":
                                    return l.padding;
                                case"end":
                        ...
                        p = w ? {x: s.left + M(f, g[0]), y: s.top + l.padding, line: 0} : {
                            x: s.left + l.padding,
                            y: s.top + M(u, h[0]),
                            line: 0
                        ...
                        W.each(s.legendItems, function (e, t) {
                            var n = m.measureText(e.text).width, i = b + y / 2 + n, r = p.x, a = p.y;
                            ...
                            !function (e, t, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (m.fillStyle = Mi(n.fillStyle, c), m.lineCap = Mi(n.lineCap, d.borderCapStyle), m.lineDashOffset = Mi(n.lineDashOffset, d.borderDashOffset), m.lineJoin = Mi(n.lineJoin, d.borderJoinStyle), m.lineWidth = i, m.strokeStyle = Mi(n.strokeStyle, c), m.setLineDash && m.setLineDash(Mi(n.lineDash, d.borderDash)), l && l.usePointStyle) {
                                        var r = b * Math.SQRT2 / 2, a = v.xPlus(e, b / 2), o = t + y / 2;
                            ...
                            }(o, a, e), x[t].left = v.leftForLtr(o, x[t].width), function (e, t, n, i) {
                                var r = y / 2, a = v.xPlus(e, b + r), o = t + r;
                    ...
                    var n, i, r;
                    if (e >= this.left && e <= this.right && t >= this.top && t <= this.bottom) for (r = this.legendHitBoxes, n = 0; n < r.length; ++n) if (e >= (i = r[n]).left && e <= i.left + i.width && t >= i.top && t <= i.top + i.height) return this.legendItems[n];
                    return null
                }, handleEvent: function (e) {
                    var t, n = this.options, i = "mouseup" === e.type ? "click" : e.type;
                    if ("mousemove" === i) {
            ...
            var Ci = {
                id: "legend", _element: _i, beforeInit: function (e) {
            ...
            var Ti = $.extend({
                ...
                beforeFit: ki,
                fit: function () {
                    var e, t = this.options, n = this.minSize = {}, i = this.isHorizontal();
                ...
                draw: function () {
                    var e = this.ctx, t = this.options;
                    if (t.display) {
                        var n, i, r, a = W.options._parseFont(t), o = a.lineHeight, s = o / 2 + t.padding, l = 0,
                            c = this.top, d = this.left, u = this.bottom, h = this.right;
                        ...
                        var f = t.text;
                        if (W.isArray(f)) for (var g = 0, p = 0; p < f.length; ++p) e.fillText(f[p], 0, g, n), g += o; else e.fillText(f, 0, 0, n);
                        e.restore()
                    }
                }
            });
            ...
            var Ai = {}, Ei = yi, Oi = Ci, Pi = {
                id: "title", _element: Ti, beforeInit: function (e) {
            ...
            function Ri(e, t, n) {
                var i = document.defaultView, r = W._getParentNode(e), a = i.getComputedStyle(e)[t],
                    o = i.getComputedStyle(r)[t], s = Vi(a), l = Vi(o), c = Number.POSITIVE_INFINITY;
            ...
            for (var zi in Ai.filler = Ei, Ai.legend = Oi, Ai.title = Pi, (Qt.helpers = W).where = function (e, t) {
                ...
                var n = t.x - e.x, i = t.y - e.y, r = Math.sqrt(n * n + i * i), a = Math.atan2(i, n);
                ...
                var r = e.skip ? t : e, a = t, o = n.skip ? t : n,
                    s = Math.sqrt(Math.pow(a.x - r.x, 2) + Math.pow(a.y - r.y, 2)),
                    l = Math.sqrt(Math.pow(o.x - a.x, 2) + Math.pow(o.y - a.y, 2)), c = s / (s + l), d = l / (s + l),
                    u = i * (c = isNaN(c) ? 0 : c), h = i * (d = isNaN(d) ? 0 : d);
                return {
                    previous: {x: a.x - u * (o.x - r.x), y: a.y - u * (o.y - r.y)},
                ...
                for (t = 0; t < u; ++t) if (!(i = d[t]).model.skip) {
                ...
                var n = Math.floor(W.log10(e)), i = e / Math.pow(10, n);
                ...
                var n, i, r = e.originalEvent || e, a = e.target || e.srcElement, o = a.getBoundingClientRect(),
                    s = r.touches;
                i = s && 0 < s.length ? (n = s[0].clientX, s[0].clientY) : (n = r.clientX, r.clientY);
                var l = parseFloat(W.getStyle(a, "padding-left")), c = parseFloat(W.getStyle(a, "padding-top")),
                    d = parseFloat(W.getStyle(a, "padding-right")), u = parseFloat(W.getStyle(a, "padding-bottom")),
                    h = o.right - o.left - l - d, f = o.bottom - o.top - c - u;
                return {
                ...
                if (1 !== n) {
                    var i = e.canvas, r = e.height, a = e.width;
                ...
                var r = (i = i || {}).data = i.data || {}, a = i.garbageCollect = i.garbageCollect || [];
                i.font !== t && (r = i.data = {}, a = i.garbageCollect = [], i.font = t), e.font = t;
                var o, s, l, c, d, u = 0, h = n.length;
                for (o = 0; o < h; o++) if (null != (c = n[o]) && !0 !== W.isArray(c)) u = W.measureText(e, r, a, u, c); else if (W.isArray(c)) for (s = 0, l = c.length; s < l; s++) null == (d = c[s]) || W.isArray(d) || (u = W.measureText(e, r, a, u, d));
                var f = a.length / 2;
                if (f > n.length) {
        ...
        t = this, n = function () {
            ...
            function p(e) {
                if (null == e._isValid) {
                    var t = g(e), n = r.call(t.parsedDateParts, function (e) {
                            return null != e
                        }),
            ...
            function y(e, t) {
                var n, i, r;
                if (a(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), a(t._i) || (e._i = t._i), a(t._f) || (e._f = t._f), a(t._l) || (e._l = t._l), a(t._strict) || (e._strict = t._strict), a(t._tzm) || (e._tzm = t._tzm), a(t._isUTC) || (e._isUTC = t._isUTC), a(t._offset) || (e._offset = t._offset), a(t._pf) || (e._pf = g(t)), a(t._locale) || (e._locale = t._locale), 0 < m.length) for (n = 0; n < m.length; n++) a(r = t[i = m[n]]) || (e[i] = r);
                return e
            }
            ...
            var G = /\d/, U = /\d\d/, q = /\d{3}/, X = /\d{4}/, $ = /[+-]?\d{6}/, Z = /\d\d?/, K = /\d\d\d\d?/,
                J = /\d\d\d\d\d\d?/, Q = /\d{1,3}/, ee = /\d{1,4}/, te = /[+-]?\d{1,6}/, ne = /\d+/, ie = /[+-]?\d+/,
                re = /Z|[+-]\d\d:?\d\d/gi, ae = /Z|[+-]\d\d(?::?\d\d)?/gi,
            ...
            var ge = 0, pe = 1, ve = 2, me = 3, ye = 4, be = 5, xe = 6, Me = 7, we = 8;
            ...
            function We(e, t, n) {
                var i, r, a = Ie(e.year(), t, n), o = Math.floor((e.dayOfYear() - a - 1) / 7) + 1;
            ...
            function ft(e) {
                ...
                if (!e._d) {
                    for (i = function (e) {
                        ...
                        var t, n, i, r, a, o, s, l;
                        if (null != (t = e._w).GG || null != t.W || null != t.E) a = 1, o = 4, n = ht(t.GG, e._a[ge], We(Lt(), 1, 4).year), i = ht(t.W, 1), ((r = ht(t.E, 1)) < 1 || 7 < r) && (l = !0); else {
            ...
            function xt(e) {
                var t, n, i, r, a, o, s = e._i, l = gt.exec(s) || pt.exec(s);
                if (l) {
                    for (g(e).iso = !0, t = 0, n = mt.length; t < n; t++) if (mt[t][1].exec(l[1])) {
                        r = mt[t][0], i = !1 !== mt[t][2];
                        break
                    }
            ...
            function Ct(e) {
                if (e._f !== h.ISO_8601) if (e._f !== h.RFC_2822) {
                    e._a = [], g(e).empty = !0;
                    var t, n, i, r, a, o, s, l, c = "" + e._i, d = c.length, u = 0;
            ...
            function Tt(e, t, n, i, r) {
                ...
                return !0 !== n && !1 !== n || (i = n, n = void 0), (s(e) && function (e) {
                    ...
                    return !0
                }(e) || o(e) && 0 === e.length) && (e = void 0), a._isAMomentObject = !0, a._useUTC = a._isUTC = r, a._l = n, a._i = e, a._f = t, a._strict = i, function (e) {
                    var t = new b(ut(kt(e)));
            ...
            function Dt(e) {
                var t = V(e), n = t.year || 0, i = t.quarter || 0, r = t.month || 0, a = t.week || t.isoWeek || 0,
                    o = t.day || 0, s = t.hour || 0, l = t.minute || 0, c = t.second || 0, d = t.millisecond || 0;
            ...
            function Ht(e, t) {
                ...
                var i = ((n[n.length - 1] || []) + "").match(Bt) || ["-", 0, 0], r = 60 * i[1] + w(i[2]);
            ...
            var $t = qt(1, "add"), Zt = qt(-1, "subtract");
            ...
            function sn(e, t, n, i, r) {
                ...
                return null == e ? We(this, i, r).year : ((a = je(e, i, r)) < t && (t = a), function (e, t, n, i, r) {
                    var a = Fe(e, t, n, i, r), o = Ne(a.year, 0, a.dayOfYear);
            ...
            gn.add = $t, gn.calendar = function (e, t) {
                var n = e || Lt(), i = Nt(n, this).startOf("day"), r = h.calendarFormat(this, i) || "sameElse",
                ...
                }(e = V(e)), i = 0; i < n.length; i++) this[n[i].unit](e[n[i].unit]); else if (L(this[e = D(e)])) return this[e](t);
                return this
            ...
            vn.calendar = function (e, t, n) {
                ...
                if (this._monthsParseExact) return function (e, t, n) {
                    ...
                    if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; i < 12; ++i) a = u([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(a, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(a, "").toLocaleLowerCase();
            ...
            var kn = Cn("ms"), Tn = Cn("s"), Ln = Cn("m"), An = Cn("h"), En = Cn("d"), On = Cn("w"), Pn = Cn("M"),
                Dn = Cn("Q"), Vn = Cn("y");
            ...
            var zn = Rn("milliseconds"), Bn = Rn("seconds"), Hn = Rn("minutes"), Nn = Rn("hours"), In = Rn("days"),
                Fn = Rn("months"), Wn = Rn("years");
            var jn = Math.round, Yn = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11};
            var Gn = Math.abs;
            ...
            function qn() {
                ...
                var e, t, n = Gn(this._milliseconds) / 1e3, i = Gn(this._days), r = Gn(this._months);
                t = M((e = M(n / 60)) / 60), n %= 60, e %= 60;
                var a = M(r / 12), o = r %= 12, s = i, l = t, c = e, d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
                    u = this.asSeconds();
                if (!u) return "P0D";
                var h = u < 0 ? "-" : "", f = Un(this._months) !== Un(u) ? "-" : "",
                    g = Un(this._days) !== Un(u) ? "-" : "", p = Un(this._milliseconds) !== Un(u) ? "-" : "";
            ...
            return Xn.isValid = function () {
                ...
                var e, t, n, i, r, a = this._milliseconds, o = this._days, s = this._months, l = this._data;
                ...
                var t = this.localeData(), n = function (e, t, n) {
                    var i = Yt(e).abs(), r = jn(i.as("s")), a = jn(i.as("m")), o = jn(i.as("h")), s = jn(i.as("d")),
                        l = jn(i.as("M")), c = jn(i.as("y")),
                        d = r <= Yn.ss && ["s", r] || r < Yn.s && ["ss", r] || a <= 1 && ["m"] || a < Yn.m && ["mm", a] || o <= 1 && ["h"] || o < Yn.h && ["hh", o] || s <= 1 && ["d"] || s < Yn.d && ["dd", s] || l <= 1 && ["M"] || l < Yn.M && ["MM", l] || c <= 1 && ["y"] || ["yy", c];
                    return d[2] = t, d[3] = 0 < +e, d[4] = n, function (e, t, n, i, r) {
        ...
        (function (Fr) {
            ...
            e = this, t = function () {
                ...
                var h, f, g, p = "object",
                    ...
                    }), M = {}.propertyIsEnumerable, w = Object.getOwnPropertyDescriptor, _ = {
                        f: w && !M.call({1: 2}, 1) ? function (e) {
                            var t = w(this, e);
                            return !!t && t.enumerable
                        } : M
                    }, C = {}.toString, k = "".split, T = v(function () {
                        return !Object("z").propertyIsEnumerable(0)
                    }) ? function (e) {
                        return "String" == r(e) ? k.call(e, "") : Object(e)
                    } : Object, L = {}.hasOwnProperty, A = y.document, E = m(A) && m(A.createElement),
                    O = !b && !v(function () {
                    ...
                    }), P = Object.getOwnPropertyDescriptor, D = {
                        f: b ? P : function (e, t) {
                    ...
                    }), H = B("native-function-to-string", Function.toString), N = y.WeakMap,
                    I = "function" == typeof N && /native code/.test(H.call(N)), F = 0, W = Math.random(),
                    j = B("keys"), Y = {}, G = y.WeakMap;
                if (I) {
                    var U = new G, q = U.get, X = U.has, $ = U.set;
                    h = function (e, t) {
                        return $.call(U, e, t), t
                    }, f = function (e) {
                        return q.call(U, e) || {}
                ...
                function te(c) {
                    return function (e, t, n) {
                        var i, r, a, o = d(e), s = ee(o.length), l = (r = s, (a = Q(n)) < 0 ? be(a + r, 0) : xe(a, r));
                        if (c && t != t) {
                ...
                function ae(e, t) {
                    ...
                    if (n = l ? y : c ? y[s] || u(s, {}) : (y[s] || {}).prototype) for (i in t) {
                ...
                function ue(f) {
                    var g = 1 == f, p = 2 == f, v = 3 == f, m = 4 == f, y = 6 == f, b = 5 == f || y;
                    return function (e, t, n, i) {
                        for (var r, a, o = le(e), s = T(o), l = se(t, n, 3), c = ee(s.length), d = 0, u = i || de, h = g ? u(e, c) : p ? u(e, 0) : void 0; d < c; d++) if ((b || d in s) && (a = l(r = s[d], d, o), f)) if (g) h[d] = a; else if (a) switch (f) {
                            case 3:
                                return !0;
                            case 5:
                                return r;
                ...
                var fe = {
                        set: h, get: f, has: g, enforce: function (e) {
                            return g(e) ? f(e) : h(e, {})
                        ...
                        var t = fe.get, s = fe.enforce, l = String(H).split("toString");
                        B("inspectSource", function (e) {
                            return H.call(e)
                        }), (e.exports = function (e, t, n, i) {
                            var r = !!i && !!i.unsafe, a = !!i && !!i.enumerable, o = !!i && !!i.noTargetGet;
                    ...
                    }), pe = y, ve = Math.ceil, me = Math.floor, ye = Math.min, be = Math.max, xe = Math.min,
                    Me = (te(!0), te(!1)),
                    we = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"],
                    _e = we.concat("length", "prototype"), Se = {
                        f: Object.getOwnPropertyNames || function (e) {
                            return ne(e, _e)
                        }
                    }, Ce = {f: Object.getOwnPropertySymbols}, ke = J("Reflect", "ownKeys") || function (e) {
                        var t = Se.f(S(e)), n = Ce.f;
                        return n ? t.concat(n(e)) : t
                    }, Te = /#|\.prototype\./, Le = re.normalize = function (e) {
                        return String(e).replace(Te, ".").toLowerCase()
                    }, Ae = re.data = {}, Ee = re.NATIVE = "N", Oe = re.POLYFILL = "P", Pe = re, De = D.f,
                    Ve = Array.isArray || function (e) {
                        return "Array" == r(e)
                    }, Re = !!Object.getOwnPropertySymbols && !v(function () {
                        return !String(Symbol())
                    }), ze = y.Symbol, Be = B("wks"), He = ce("species"), Ne = [].push, Ie = {
                        forEach: ue(0),
                        map: ue(1),
                        filter: ue(2),
                        some: ue(3),
                        ...
                        find: ue(5),
                        findIndex: ue(6)
                    }, Fe = Ie.forEach, We = he("forEach") ? function (e) {
                ...
                for (var Ye in je) {
                    var Ge = y[Ye], Ue = Ge && Ge.prototype;
                ...
                var Ke = Object.keys || function (e) {
                    ...
                    return e
                }, Qe = J("document", "documentElement"), et = o("IE_PROTO"), tt = function () {
                    var e, t = a("iframe"), n = we.length;
                ...
                Y[et] = !0;
                var it = ce("unscopables"), rt = Array.prototype;
                ...
                var ot, st, lt, ct = {}, dt = !v(function () {
                    function e() {
                    }

                    return e.prototype.constructor = null, Object.getPrototypeOf(new e) !== e.prototype
                }), ut = o("IE_PROTO"), ht = Object.prototype, ft = dt ? Object.getPrototypeOf : function (e) {
                ...
                function bt(e, t, n, i, r, a, o) {
                    ...
                    var u, h, f, g = t + " Iterator", p = !1, v = e.prototype,
                        m = v[Tt] || v["@@iterator"] || r && v[r], y = !kt && m || d(r),
                    ...
                    if (b && (u = ft(b.call(new e)), Ct !== Object.prototype && u.next && (ft(u) !== Ct && (St ? St(u, Ct) : "function" != typeof u[Tt] && z(u, Tt, yt)), vt(u, g, !0))), "values" == r && m && "values" !== m.name && (p = !0, y = function () {
                        return m.call(this)
                    }), v[Tt] !== y && z(v, Tt, y), ct[t] = y, r) if (h = {
                        values: d("values"),
                        keys: a ? y : d("keys"),
                        entries: d("entries")
                    }, o) for (f in h) !kt && !p && f in v || ge(v, f, h[f]); else ae({
                        target: t,
                        proto: !0,
                        forced: kt || p
                    }, h);
                ...
                var xt = {IteratorPrototype: ot, BUGGY_SAFARI_ITERATORS: pt}, Mt = R.f, wt = ce("toStringTag"),
                    _t = xt.IteratorPrototype, St = Object.setPrototypeOf || ("__proto__" in {} ? function () {
                        var n, i = !1, e = {};
                        try {
                    ...
                    }() : void 0), Ct = xt.IteratorPrototype, kt = xt.BUGGY_SAFARI_ITERATORS, Tt = ce("iterator"),
                    Lt = fe.set, At = fe.getterFor("Array Iterator"), Et = bt(Array, "Array", function (e, t) {
                        Lt(this, {type: "Array Iterator", target: d(e), index: 0, kind: t})
                    }, function () {
                        var e = At(this), t = e.target, n = e.kind, i = e.index++;
                        return !t || i >= t.length ? {value: e.target = void 0, done: !0} : "keys" == n ? {
                            value: i,
                            done: !1
                        } : "values" == n ? {value: t[i], done: !1} : {value: [i, t[i]], done: !1}
                    }, "values");
                ct.Arguments = ct.Array, at("keys"), at("values"), at("entries");
                var Ot = Object.assign, Pt = !Ot || v(function () {
                    var e = {}, t = {}, n = Symbol();
                    return e[n] = 7, "abcdefghijklmnopqrst".split("").forEach(function (e) {
                        t[e] = e
                    }), 7 != Ot({}, e)[n] || "abcdefghijklmnopqrst" != Ke(Ot({}, t)).join("")
                }) ? function (e, t) {
                    for (var n = le(e), i = arguments.length, r = 1, a = Ce.f, o = _.f; r < i;) for (var s, l = T(arguments[r++]), c = a ? Ke(l).concat(a(l)) : Ke(l), d = c.length, u = 0; u < d;) s = c[u++], b && !o.call(l, s) || (n[s] = l[s]);
                    return n
                } : Ot;
                ...
                var Vt = ce("toStringTag"), Rt = "Arguments" == r(function () {
                    return arguments
                }()), zt = {};
                zt[ce("toStringTag")] = "z";
                var Bt = "[object z]" !== String(zt) ? function () {
                    return "[object " + Dt(this) + "]"
                } : zt.toString, Ht = Object.prototype;
                ...
                var It = "\t\n\v\f\r                　\u2028\u2029\ufeff", Ft = "[" + It + "]",
                    Wt = RegExp("^" + Ft + Ft + "*"), jt = RegExp(Ft + Ft + "*$"), Yt = (Nt(1), Nt(2), Nt(3)),
                    Gt = y.parseInt, Ut = /^[+-]?0[Xx]/,
                ...
                function Xt(s) {
                    return function (e, t) {
                        var n, i, r = String(l(e)), a = Q(t), o = r.length;
                ...
                var $t = {codeAt: Xt(!1), charAt: Xt(!0)}, Zt = $t.charAt, Kt = fe.set,
                    Jt = fe.getterFor("String Iterator");
                bt(String, "String", function (e) {
                    Kt(this, {type: "String Iterator", string: String(e), index: 0})
                }, function () {
                    var e, t = Jt(this), n = t.string, i = t.index;
                    return i >= n.length ? {value: void 0, done: !0} : (e = Zt(n, i), t.index += e.length, {
                        value: e,
                        done: !1
                    })
                });
                ...
                var nn = !v(function () {
                        ...
                        var t = R.f, i = s("meta"), r = 0, a = Object.isExtensible || function () {
                            return !0
                        }, o = e.exports = {
                        ...
                        Y[i] = !0
                    }), an = (rn.REQUIRED, rn.fastKey, rn.getWeakData, rn.onFreeze, ce("iterator")), on = Array.prototype,
                    sn = ce("iterator"), ln = t(function (e) {
                        function f(e, t) {
                ...
                function fn(s, e, t, l, i) {
                    ...
                    var c = y[s], r = c && c.prototype, d = c, u = l ? "set" : "add", a = {};
                    if (Pe(s, "function" != typeof c || !(i || r.forEach && !v(function () {
                        (new c).entries().next()
                    })))) d = t.getConstructor(e, s, l, u), rn.REQUIRED = !0; else if (Pe(s, !0)) {
                        var o = new d, h = o[u](i ? {} : -0, 1) != o, f = v(function () {
                            o.has(1)
                        }), g = function () {
                            if (!dn) return !1;
                            var e = !1;
                ...
                var vn = rn.getWeakData, mn = fe.set, yn = fe.getterFor, bn = Ie.find, xn = Ie.findIndex, Mn = 0,
                    wn = function () {
                        this.entries = []
                    };
                wn.prototype = {
                ...
                var _n = {
                    ...
                    var i, r = fe.enforce, n = !y.ActiveXObject && "ActiveXObject" in y, a = Object.isExtensible,
                        o = e.exports = fn("WeakMap", t, _n, !0, !0);
                    if (I && n) {
                        i = _n.getConstructor(t, "WeakMap", !0), rn.REQUIRED = !0;
                        var s = o.prototype, l = s.delete, c = s.has, d = s.get, u = s.set;
                        Qt(s, {
                            delete: function (e) {
                ...
                }), ce("iterator")), Cn = ce("toStringTag"), kn = Et.values;
                for (var Tn in je) {
                    var Ln = y[Tn], An = Ln && Ln.prototype;
                    if (An) {
                        if (An[Sn] !== kn) try {
                            z(An, Sn, kn)
                        } catch (e) {
                        ...
                        if (An[Cn] || z(An, Cn, Tn), je[Tn]) for (var En in Et) if (An[En] !== Et[En]) try {
                            z(An, En, Et[En])
                        } catch (e) {
                            An[En] = Et[En]
                        }
                ...
                var Pn = "Expected a function", Dn = NaN, Vn = "[object Symbol]", Rn = /^\s+|\s+$/g,
                    zn = /^[-+]0x[0-9a-f]+$/i, Bn = /^0b[01]+$/i, Hn = /^0o[0-7]+$/i, Nn = parseInt,
                    In = "object" == typeof e && e && e.Object === Object && e,
                    Fn = "object" == typeof self && self && self.Object === Object && self,
                    Wn = In || Fn || Function("return this")(), jn = Object.prototype.toString, Yn = Math.max,
                    Gn = Math.min;
                ...
                function Xn(e, t, n) {
                    ...
                    return Un(n) && (i = "leading" in n ? !!n.leading : i, r = "trailing" in n ? !!n.trailing : r), function (i, r, e) {
                        var a, o, n, s, l, c, d = 0, u = !1, h = !1, t = !0;
                ...
                var Zn = /^\s+|\s+$/g, Kn = /^[-+]0x[0-9a-f]+$/i, Jn = /^0b[01]+$/i, Qn = /^0o[0-7]+$/i, ei = parseInt,
                    ti = "object" == typeof e && e && e.Object === Object && e,
                    ni = "object" == typeof self && self && self.Object === Object && self,
                    ii = ti || ni || Function("return this")(), ri = Object.prototype.toString, ai = Math.max,
                    oi = Math.min;
                ...
                var di, ui = "Expected a function", hi = "__lodash_hash_undefined__", fi = "[object Function]",
                    gi = "[object GeneratorFunction]", pi = /^\[object .+?Constructor\]$/,
                    vi = "object" == typeof e && e && e.Object === Object && e,
                    mi = "object" == typeof self && self && self.Object === Object && self,
                    yi = vi || mi || Function("return this")(), bi = Array.prototype, xi = Function.prototype,
                    Mi = Object.prototype, wi = yi["__core-js_shared__"],
                    _i = (di = /[^.]+$/.exec(wi && wi.keys && wi.keys.IE_PROTO || "")) ? "Symbol(src)_1." + di : "",
                    Si = xi.toString, Ci = Mi.hasOwnProperty, ki = Mi.toString,
                    Ti = RegExp("^" + Si.call(Ci).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                    Li = bi.splice, Ai = zi(yi, "Map"), Ei = zi(Object, "create");
                ...
                Oi.prototype.clear = function () {
                    ...
                    this.__data__ = {hash: new Oi, map: new (Ai || Pi), string: new Oi}
                ...
                var Ii = Bi, Fi = function () {
                    ...
                    Ui = "undefined" != typeof MutationObserver, qi = (Zi.prototype.addObserver = function (e) {
                    ...
                    }, Zi.instance_ = null, Zi), Xi = function (e) {
                ...
                function er(e) {
                    return Wi ? Qi(e) ? tr(0, 0, (t = e.getBBox()).width, t.height) : function (e) {
                        ...
                        if (!t && !n) return $i;
                        var i = Xi(e).getComputedStyle(e), r = function (e) {
                            for (var t = {}, n = 0, i = ["top", "right", "bottom", "left"]; n < i.length; n++) {
                                var r = i[n], a = e["padding-" + r];
                                t[r] = Ki(a)
                            }
                            return t
                        }(i), a = r.left + r.right, o = r.top + r.bottom, s = Ki(i.width), l = Ki(i.height);
                        if ("border-box" === i.boxSizing && (Math.round(s + a) !== t && (s -= Ji(i, "left", "right") + a), Math.round(l + o) !== n && (l -= Ji(i, "top", "bottom") + o)), e !== Xi(e).document.documentElement) {
                            var c = Math.round(s + a) - t, d = Math.round(l + o) - n;
                ...
                function nr(e, t) {
                    var n, i, r, a, o, s, l,
                        c = (i = (n = t).x, r = n.y, a = n.width, o = n.height, s = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(s.prototype), Ni(l, {
                            x: i,
                            y: r,
                            width: a,
                            height: o,
                ...
                function ir(e) {
                    ...
                    var t = qi.getInstance(), n = new ar(e, t, this);
                    or.set(this, n)
                }
                ...
                }, lr), ar = (sr.prototype.observe = function (e) {
                    if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
                ...
                }, sr), or = "undefined" != typeof WeakMap ? new WeakMap : new Fi;
                ...
                var cr = void 0 !== ji.ResizeObserver ? ji.ResizeObserver : ir, dr = null, ur = null;
                ...
                var fr = function () {
                    function l(e, t) {
                        ...
                        this.onScroll = function () {
                            ...
                            var t = s.axis[s.draggedAxis].track, n = t.rect[s.axis[s.draggedAxis].sizeAttr],
                    ...
                    l.getRtlHelpers = function () {
                        ...
                        t.scrollLeft = 0;
                        var i = l.getOffset(t), r = l.getOffset(n);
                        t.scrollLeft = 999;
                        var a = l.getOffset(n);
                        return {
                    ...
                    return e.init = function () {
                        ...
                        var e = this.heightAutoObserverEl.offsetHeight <= 1,
                            t = this.heightAutoObserverEl.offsetWidth <= 1, n = this.contentEl.offsetWidth,
                            i = this.contentWrapperEl.offsetWidth, r = this.elStyles.overflowX,
                        ...
                        var t, n = this.contentEl[this.axis[e].scrollSizeAttr],
                            i = this.axis[e].track.el[this.axis[e].offsetSizeAttr], r = i / n;
                        ...
                        if (void 0 === e && (e = "y"), this.axis[e].isOverflowing) {
                            var t = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
                                ...
                                i = parseInt(this.elStyles[this.axis[e].sizeAttr], 10), r = this.axis[e].scrollbar,
                        ...
                        void 0 === t && (t = "y");
                        var n = this.axis[t].scrollbar, i = "y" === t ? e.pageY : e.pageX;
                        ...
                        !function e() {
                            var t, n;
                            -1 == o ? s < a && (a -= 40, r.contentWrapperEl.scrollTo(((t = {})[r.axis[i].offsetAttr] = a, t)), window.requestAnimationFrame(e)) : a < s && (a += 40, r.contentWrapperEl.scrollTo(((n = {})[r.axis[i].offsetAttr] = a, n)), window.requestAnimationFrame(e))
                        }()
                ...
                function gr(c) {
                    return function (e, t, n, i) {
                        oe(t);
                        var r = le(e), a = T(r), o = ee(r.length), s = c ? o - 1 : 0, l = c ? -1 : 1;
                        if (n < 2) for (; ;) {
                            if (s in a) {
                                i = a[s], s += l;
                                break
                ...
                var pr = [gr(!1), gr(!0)][0];
                ae({target: "Array", proto: !0, forced: he("reduce")}, {
                    reduce: function (e) {
                        return pr(this, e, arguments.length, 1 < arguments.length ? arguments[1] : void 0)
                    }
                });
                var vr = R.f, mr = Function.prototype, yr = mr.toString, br = /^\s*function ([^ (]*)/;
                ...
                var xr, Mr, wr = RegExp.prototype.exec, _r = String.prototype.replace, Sr = wr,
                ...
                function Lr(n, e, t, i) {
                    ...
                    if (!a || !o || "replace" === n && !Pr || "split" === n && !Dr) {
                        var s = /./[r], l = t(r, ""[n], function (e, t, n, i, r) {
                            return t.exec === Tr ? a && !r ? {done: !0, value: s.call(t, n, i)} : {
                                done: !0,
                                value: e.call(n, t, i)
                            } : {done: !1}
                        }), c = l[0], d = l[1];
                ...
                var Or = ce("species"), Pr = !v(function () {
                    var e = /./;
                ...
                Lr("match", 1, function (i, c, d) {
                    return [function (e) {
                        var t = l(this), n = null == e ? void 0 : e[i];
                        return void 0 !== n ? n.call(e, t) : new RegExp(e)[i](String(t))
                    }, function (e) {
                        var t = d(c, e, this);
                        if (t.done) return t.value;
                        var n = S(e), i = String(this);
                ...
                var Rr = Math.max, zr = Math.min, Br = Math.floor, Hr = /\$([$&'`]|\d\d?|<[^>]*>)/g,
                    Nr = /\$([$&'`]|\d\d?)/g;
                Lr("replace", 2, function (r, M, w) {
                    return [function (e, t) {
                        var n = l(this), i = null == e ? void 0 : e[r];
                        return void 0 !== i ? i.call(e, n, t) : M.call(String(n), e, t)
                    }, function (e, t) {
                        var n = w(M, e, this, t);
                        if (n.done) return n.value;
                        var i = S(e), r = String(this), a = "function" == typeof t;
                        a || (t = String(t));
                        var o = i.global;
                        if (o) {
                            var s = i.unicode;
                    ...
                    function _(a, o, s, l, c, e) {
                        var d = s + a.length, u = l.length, t = Nr;
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.addCSSRule = function (e, t, n, i) {
            "insertRule" in e ? e.insertRule(t + "{" + n + "}", i) : e.addRule(t, n, i)
        };
        e("./raf.js")
    }, {"./raf.js": 35}], 6: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.addClass = void 0;
        var i = e("./hasClass.js"), r = i.classListSupport ? function (e, t) {
            (0, i.hasClass)(e, t) || e.classList.add(t)
        } : function (e, t) {
            (0, i.hasClass)(e, t) || (e.className += " " + t)
        };
        n.addClass = r
    }, {"./hasClass.js": 27}], 7: [function (e, t, n) {
        "use strict";
    ...
    }, {"./passiveOption.js": 33}], 8: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.arrayFromNodeList = function (e) {
        ...
        var i = window, r = i.cancelAnimationFrame || i.mozCancelAnimationFrame || function (e) {
            clearTimeout(e)
        };
        n.caf = r
    }, {}], 10: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.calc = function () {
            var e = document, t = (0, c.getBody)(), n = (0, d.setFakeBody)(t), i = e.createElement("div"), r = !1;
            t.appendChild(i);
            try {
                for (var a, o = "(10px * 10)", s = ["calc" + o, "-moz-calc" + o, "-webkit-calc" + o], l = 0; l < 3; l++) if (a = s[l], i.style.width = a, 100 === i.offsetWidth) {
                    r = a.replace(o, "");
                    break
                }
            } catch (e) {
        ...
        var c = e("./getBody.js"), d = e("./setFakeBody.js"), u = e("./resetFakeBody.js")
    }, {"./getBody.js": 20, "./resetFakeBody.js": 40, "./setFakeBody.js": 42}], 11: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.checkStorageValue = function (e) {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.forEach = function (e, t, n) {
            for (var i = 0, r = e.length; i < r; i++) t.call(n, e[i], i)
        }
    }, {}], 19: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.getAttr = function (e, t) {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.getCssRulesLength = function (e) {
            return ("insertRule" in e ? e.cssRules : e.rules).length
        }
    }, {}], 22: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.getEndProperty = function (e, t) {
            var n = !1;
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.getSlideId = function () {
            var e = window.tnsId;
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.has3DTransforms = function (e) {
            ...
            var t, n = document, i = (0, s.getBody)(), r = (0, l.setFakeBody)(i), a = n.createElement("p"),
        ...
        var s = e("./getBody.js"), l = e("./setFakeBody.js"), c = e("./resetFakeBody.js")
    }, {"./getBody.js": 20, "./resetFakeBody.js": 40, "./setFakeBody.js": 42}], 26: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.hasAttr = function (e, t) {
            return e.hasAttribute(t)
        }
    }, {}], 27: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), Object.defineProperty(n, "classListSupport", {
            enumerable: !0,
            get: function () {
                return i.classListSupport
            }
        }), n.hasClass = void 0;
        var i = e("./classListSupport.js"), r = i.classListSupport ? function (e, t) {
            return e.classList.contains(t)
        } : function (e, t) {
            return 0 <= e.className.indexOf(t)
        };
        n.hasClass = r
    }, {"./classListSupport.js": 13}], 28: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.hideElement = function (e, t) {
            "none" !== e.style.display && (e.style.display = "none")
        }
    }, {}], 29: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.isNodeList = function (e) {
            return void 0 !== e.item
        }
    }, {}], 30: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.isVisible = function (e) {
            return "none" !== window.getComputedStyle(e).display
        }
    }, {}], 31: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.jsTransform = function (t, n, i, r, e, a, o) {
            var s = Math.min(a, 10), l = 0 <= e.indexOf("%") ? "%" : "px",
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.mediaquerySupport = function () {
            var e, t = document, n = (0, s.getBody)(), i = (0, l.setFakeBody)(n), r = t.createElement("div"),
                a = t.createElement("style"), o = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
        ...
        var s = e("./getBody.js"), l = e("./setFakeBody.js"), c = e("./resetFakeBody.js")
    }, {"./getBody.js": 20, "./resetFakeBody.js": 40, "./setFakeBody.js": 42}], 33: [function (e, t, n) {
        "use strict";
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.percentageLayout = function () {
            var e, t = document, n = (0, l.getBody)(), i = (0, c.setFakeBody)(n), r = t.createElement("div"),
                a = t.createElement("div"), o = "";
        ...
        var l = e("./getBody.js"), c = e("./setFakeBody.js"), d = e("./resetFakeBody.js")
    }, {"./getBody.js": 20, "./resetFakeBody.js": 40, "./setFakeBody.js": 42}], 35: [function (e, t, n) {
        "use strict";
    ...
    }, {"./isNodeList.js": 29}], 37: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.removeCSSRule = function (e, t) {
            "deleteRule" in e ? e.deleteRule(t) : e.removeRule(t)
        };
        e("./raf.js")
    }, {"./raf.js": 35}], 38: [function (e, t, n) {
        "use strict";
        ...
        n.removeClass = r
    }, {"./hasClass.js": 27}], 39: [function (e, t, n) {
        "use strict";
    ...
    }, {"./passiveOption.js": 33}], 40: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.resetFakeBody = function (e, t) {
            e.fake && (e.remove(), i.docElement.style.overflow = t, i.docElement.offsetHeight)
        };
        var i = e("./docElement.js")
    }, {"./docElement.js": 15}], 41: [function (e, t, n) {
        "use strict";
    ...
    }, {"./isNodeList.js": 29}], 42: [function (e, t, n) {
        "use strict";
        ...
        var i = e("./docElement.js")
    }, {"./docElement.js": 15}], 43: [function (e, t, n) {
        "use strict";
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.showElement = function (e, t) {
            "none" === e.style.display && (e.style.display = "")
        }
    }, {}], 45: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: !0}), n.toDegree = function (e, t) {
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.whichProperty = function (t) {
            if ("string" == typeof t) {
                var n = [t], i = t.charAt(0).toUpperCase() + t.substr(1);
        ...
        var wi = e("./helpers/raf.js"), _i = e("./helpers/caf.js"), Si = e("./helpers/extend.js"),
            Ci = e("./helpers/checkStorageValue.js"), ki = e("./helpers/setLocalStorage.js"),
            Ti = e("./helpers/getSlideId.js"), Li = e("./helpers/calc.js"), Ai = e("./helpers/percentageLayout.js"),
            Ei = e("./helpers/mediaquerySupport.js"), Oi = e("./helpers/createStyleSheet.js"),
            Pi = e("./helpers/addCSSRule.js"), Di = e("./helpers/removeCSSRule.js"),
            Vi = e("./helpers/getCssRulesLength.js"), Ri = e("./helpers/toDegree.js"),
            zi = e("./helpers/getTouchDirection.js"), Bi = e("./helpers/forEach.js"), Hi = e("./helpers/hasClass.js"),
            Ni = e("./helpers/addClass.js"), Ii = e("./helpers/removeClass.js"), Fi = e("./helpers/hasAttr.js"),
            Wi = e("./helpers/getAttr.js"), ji = e("./helpers/setAttrs.js"), Yi = e("./helpers/removeAttrs.js"),
            Gi = e("./helpers/arrayFromNodeList.js"), Ui = e("./helpers/hideElement.js"),
            qi = e("./helpers/showElement.js"), Xi = e("./helpers/isVisible.js"), $i = e("./helpers/whichProperty.js"),
            Zi = e("./helpers/has3DTransforms.js"), Ki = e("./helpers/getEndProperty.js"),
            Ji = e("./helpers/addEvents.js"), Qi = e("./helpers/removeEvents.js"), er = e("./helpers/events.js"),
        ...
        n.tns = function e(A) {
            ...
            var E = document, v = window, r = {ENTER: 13, SPACE: 32, LEFT: 37, RIGHT: 39}, t = {},
                n = A.useLocalStorage;
            if (n) {
                var i = navigator.userAgent, a = new Date;
                try {
            ...
            if (f.forEach(function (e) {
                ...
                if (V || function e(t) {
                    ...
                    var R = A.animateIn, z = A.animateOut, _ = A.animateDelay, B = A.animateNormal
                }
                var S, H, N = "horizontal" === A.axis, C = E.createElement("div"), I = E.createElement("div"),
                    F = A.container, k = F.parentNode, T = F.outerHTML, W = F.children, j = W.length, Y = Qt(), G = !1;
                P && xn(), V && (F.className += " tns-vpfix");
                var L, U, q, X, $, Z = A.autoWidth, K = rn("fixedWidth"), J = rn("edgePadding"), Q = rn("gutter"),
                    ee = tn(), te = rn("center"), ne = Z ? 1 : Math.floor(rn("items")), ie = rn("slideBy"),
                    re = A.viewportMax || A.fixedWidthViewportWidth, ae = rn("arrowKeys"), oe = rn("speed"),
                    se = A.rewind, le = !se && A.loop, ce = rn("autoHeight"), de = rn("controls"),
                    ue = rn("controlsText"), he = rn("nav"), fe = rn("touch"), ge = rn("mouseDrag"),
                    pe = rn("autoplay"), ve = rn("autoplayTimeout"), me = rn("autoplayText"),
                    ye = rn("autoplayHoverPause"), be = rn("autoplayResetOnVisibility"),
                    xe = (0, Oi.createStyleSheet)(), Me = A.lazyload, we = (A.lazyloadSelector, []),
                    _e = le ? (X = function () {
                        {
                            if (Z || K && !re) return j - 1;
                            var e = K ? "fixedWidth" : "items", t = [];
                            if ((K || A[e] < j) && t.push(A[e]), P) for (var n in P) {
                                var i = P[n][e];
                                i && (K || i < j) && t.push(i)
                            }
                    ...
                    Se = V ? j + 2 * _e : j + _e, Ce = !(!K && !Z || le), ke = K ? qn() : null, Te = !V || !le,
                    Le = N ? "left" : "top", Ae = "", Ee = "", Oe = K ? function () {
                    ...
                    }, Pe = Zt(rn("startIndex")), De = Pe, Ve = ($t(), 0), Re = Z ? null : Oe(),
                    ze = A.preventActionWhenRunning, Be = A.swipeAngle, He = !Be || "?", Ne = !1, Ie = A.onInit,
                    Fe = new er.Events, We = " tns-slider tns-" + A.mode, je = F.id || (0, Ti.getSlideId)(),
                    Ye = rn("disable"), Ge = !1, Ue = A.freezable, qe = !(!Ue || Z) && bn(), Xe = !1, $e = {
                        click: ni, keydown: function (e) {
                            e = di(e);
                        ...
                        click: function (e) {
                            ...
                            if ((0, Fi.hasAttr)(t, "data-nav")) {
                                var n = Ct = Number((0, Wi.getAttr)(t, "data-nav")), i = K || Z ? n * j / _t : n * ne;
                    ...
                    tt = {mousedown: pi, mousemove: vi, mouseup: mi, mouseleave: mi}, nt = nn("controls"),
                    it = nn("nav"), rt = !!Z || A.navAsThumbnails, at = nn("autoplay"), ot = nn("touch"),
                    st = nn("mouseDrag"), lt = "tns-slide-active", ct = "tns-complete", dt = {
                        load: function (e) {
                            An(ui(e))
                        }, error: function (e) {
                            !function (e) {
                ...
                if (nt) var ht, ft, gt = A.controlsContainer,
                    pt = A.controlsContainer ? A.controlsContainer.outerHTML : "", vt = A.prevButton, mt = A.nextButton,
                    yt = A.prevButton ? A.prevButton.outerHTML : "", bt = A.nextButton ? A.nextButton.outerHTML : "";
                if (it) var xt, Mt = A.navContainer, wt = A.navContainer ? A.navContainer.outerHTML : "",
                    _t = Z ? j : bi(), St = 0, Ct = -1, kt = Jt(), Tt = kt, Lt = "tns-nav-active",
                    At = "Carousel Page ", Et = " (Current Slide)";
                if (at) var Ot, Pt, Dt, Vt, Rt, zt = "forward" === A.autoplayDirection ? 1 : -1, Bt = A.autoplayButton,
                    Ht = A.autoplayButton ? A.autoplayButton.outerHTML : "",
                    Nt = ["<span class='tns-visually-hidden'>", " animation</span>"];
                if (ot || st) var It, Ft, Wt = {}, jt = {}, Yt = !1, Gt = N ? function (e, t) {
                    return e.x - t.x
                } : function (e, t) {
                    return e.y - t.y
                };
                Z || Xt(Ye || qe), o && (Le = o, Ae = "translate", Ee = s ? (Ae += N ? "3d(" : "3d(0px, ", N ? ", 0px, 0px)" : ", 0px)") : (Ae += N ? "X(" : "Y(", ")")), V && (F.className = F.className.replace("tns-vpfix", "")), function () {
                    nn("gutter");
                    ...
                    if (!V) for (var e = Pe, t = Pe + Math.min(j, ne); e < t; e++) {
                        var n = W[e];
                    ...
                    if (P && O) for (var r in P) {
                        r = parseInt(r);
                        var a = P[r], o = (i = "", ""), s = "", l = "", c = "", d = Z ? null : rn("items", r),
                            u = rn("fixedWidth", r), h = rn("speed", r), f = rn("edgePadding", r),
                            g = rn("autoHeight", r), p = rn("gutter", r);
                ...
                var Ut = le ? V ? function () {
                    ...
                    if (Re < Pe) for (; Ve + j <= Pe;) Pe -= j; else if (Pe < Ve) for (; Pe <= Re - j;) Pe += j
                } : function () {
                ...
                return {
                    version: "2.9.2", getInfo: Mi, events: Fe, goTo: ti, play: function () {
                        pe && !Pt && (oi(), Vt = !1)
                    }, pause: function () {
                        Pt && (si(), Vt = !0)
                    }, isOn: G, updateSliderHeight: Bn, refresh: hn, destroy: function () {
            ...
            function pn() {
                ...
                if (it) {
                    ...
                    if (xi(), b) {
                        var r = b.substring(0, b.length - 18).toLowerCase(), a = "transition: all " + oe / 1e3 + "s";
                ...
                nt && (gt || vt && mt || (C.insertAdjacentHTML(en(A.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + je + '">' + ue[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + je + '">' + ue[1] + "</button></div>"), gt = C.querySelector(".tns-controls")), vt && mt || (vt = gt.children[0], mt = gt.children[1]), A.controlsContainer && (0, ji.setAttrs)(gt, {
                    ...
                    "aria-controls": je,
                    tabindex: "-1"
                }), (A.controlsContainer || A.prevButton && A.nextButton) && ((0, ji.setAttrs)(vt, {"data-controls": "prev"}), (0, ji.setAttrs)(mt, {"data-controls": "next"})), ht = Fn(vt), ft = Fn(mt), Yn(), gt ? (0, Ji.addEvents)(gt, $e) : ((0, Ji.addEvents)(vt, $e), (0, Ji.addEvents)(mt, $e))), Mn()
            }
            ...
            function vn() {
                ...
                }) : (P || K || Z || ce || !N) && (0, Ji.addEvents)(v, {resize: mn}), ce && ("outer" === D ? Fe.on("innerLoaded", Pn) : Ye || Pn()), Ln(), Ye ? Sn() : qe && _n(), Fe.on("indexChanged", Vn), "inner" === D && Fe.emit("innerLoaded", Mi()), "function" == typeof Ie && Ie(Mi()), G = !0
            }
            ...
            function yn(e) {
                if (G) {
                    ...
                    var r, a, o = ne, s = Ye, l = qe, c = ae, d = de, u = he, h = fe, f = ge, g = pe, p = ye, v = be,
                        m = Pe;
                    if (t) {
                        var y = K, b = ce, x = ue, M = te, w = me;
                        if (!O) var _ = Q, S = J
                    }
                    if (ae = rn("arrowKeys"), de = rn("controls"), he = rn("nav"), fe = rn("touch"), te = rn("center"), ge = rn("mouseDrag"), pe = rn("autoplay"), ye = rn("autoplayHoverPause"), be = rn("autoplayResetOnVisibility"), t && (Ye = rn("disable"), K = rn("fixedWidth"), oe = rn("speed"), ce = rn("autoHeight"), ue = rn("controlsText"), me = rn("autoplayText"), ve = rn("autoplayTimeout"), O || (J = rn("edgePadding"), Q = rn("gutter"))), Xt(Ye), ee = tn(), N && !Z || Ye || (Hn(), N || (yi(), i = !0)), (K || Z) && (ke = qn(), Re = Oe()), (t || K) && (ne = rn("items"), ie = rn("slideBy"), (a = ne !== o) && (K || Z || (Re = Oe()), Ut())), t && Ye !== s && (Ye ? Sn() : function () {
                        ...
                        if (!V) for (var t = Pe, n = Pe + j; t < n; t++) {
                            var i = W[t], r = t < Pe + ne ? R : B;
                        ...
                        if (K === y && te === M || (i = !0), ce !== b && (ce || (I.style.height = "")), de && ue !== x && (vt.innerHTML = ue[0], mt.innerHTML = ue[1]), Bt && me !== w) {
                            var C = pe ? 1 : 0, k = Bt.innerHTML, T = k.length - w[C].length;
            ...
            function bn() {
                ...
                var e = K ? (K + Q) * j : L[j], t = J ? ee + 2 * J : ee + Q;
            ...
            function Sn() {
                if (!Ge) {
                    if (xe.disabled = !0, F.className = F.className.replace(We.substring(1), ""), (0, Yi.removeAttrs)(F, ["style"]), le) for (var e = _e; e--;) V && (0, Ui.hideElement)(W[e]), (0, Ui.hideElement)(W[Se - e - 1]);
                    if (N && V || (0, Yi.removeAttrs)(I, ["style"]), !V) for (var t = Pe, n = Pe + j; t < n; t++) {
                        var i = W[t];
            ...
            function Vn() {
                Ln(), Nn(), Cn(), Yn(), function () {
                    if (he && (kt = 0 <= Ct ? Ct : Jt(), Ct = -1, kt !== Tt)) {
                        var e = xt[Tt], t = xt[kt];
                        (0, ji.setAttrs)(e, {
                            tabindex: "-1",
                            "aria-label": At + (Tt + 1)
                        }), (0, Ii.removeClass)(e, Lt), (0, ji.setAttrs)(t, {"aria-label": At + (kt + 1) + Et}), (0, Yi.removeAttrs)(t, "tabindex"), (0, Ni.addClass)(t, Lt), Tt = kt
                    }
                }()
            }
            ...
            function Bn() {
                var e = ce ? zn(Pe, ne) : zn(_e, j), t = S || I;
                t.style.height !== e && (t.style.height = e + "px")
            }

            function Hn() {
                L = [0];
                var n = N ? "left" : "top", i = N ? "right" : "bottom", r = W[0].getBoundingClientRect()[n];
            ...
            function Yn() {
                if (de && !se && !le) {
                    var e = ht ? vt.disabled : Wn(vt), t = ft ? mt.disabled : Wn(mt), n = Pe <= Ve, i = !se && Re <= Pe;
            ...
            function Xn(e) {
                var t;
                if (null == e && (e = Pe), N && !Z) if (K) t = -(K + Q) * e, te && (t += Un()); else {
                    var n = o ? Se : ne;
                    te && (e -= Un()), t = 100 * -e / n
            ...
            function ei(e) {
                if (V || Ne) {
                    if (Fe.emit("transitionEnd", Mi(e)), !V && 0 < we.length) for (var t = 0; t < we.length; t++) {
                        var n = we[t];
            ...
            function ti(e, t) {
                if (!qe) if ("prev" === e) ni(t, -1); else if ("next" === e) ni(t, 1); else {
                    if (Ne) {
                        if (ze) return;
                        ei()
                    }
                    ...
                    if (Math.abs(r)) {
                        ...
                        V ? Ft = (0, wi.raf)(function () {
                            if (N && !Z) {
                                ...
                                var t = -(It + r);
                                if (t <= 0) Pe = Ve; else if (t >= L[Se - 1]) Pe = Re; else for (var n = 0; n < Se && t >= L[n];) t > L[Pe = n] && r < 0 && (Pe += 1), n++
                            }
            ...
            function xi() {
                if (he && !rt && _t !== St) {
                    var e = St, t = _t, n = qi.showElement;
        ...
        i.createDropdown({
            ...
            animation: {type: "translate-top", speed: .3, translateOffset: {vertical: 20}}
        }), i.createDropdown({
            trigger: ".reaction-item-dropdown-trigger",
            container: ".reaction-item-dropdown",
            triggerEvent: "hover",
            offset: {bottom: 38, left: -16},
            animation: {type: "translate-bottom", speed: .3, translateOffset: {vertical: 20}}
        }), i.createDropdown({
            ...
            animation: {type: "translate-bottom", speed: .3, translateOffset: {vertical: 16}},
            closeOnDropdownClick: !0
        }), i.createDropdown({
    ...
    }, {"../utils/plugins": 72}], 50: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins");
        i.createProgressBar({
    ...
    }, {"../utils/plugins": 72}], 51: [function (e, t, n) {
        "use strict";
        ...
        !function () {
            for (var e, t, n, i = 1; ;) {
                var r = i < 10 ? "0".concat(i) : i, a = o.createSlider({
    ...
    }, {"../utils/core": 69}], 54: [function (e, t, n) {
        "use strict";
        e("../utils/core").querySelector(".form-input", function (e) {
            ...
            try {
                for (var r, a = function () {
                    ...
                    var t = e.querySelector("input"), n = e.querySelector("textarea"), i = void 0;
    ...
    }, {"../utils/core": 69}], 55: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/core": 69}], 56: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/core": 69}], 57: [function (e, t, n) {
        "use strict";
        e("../utils/core").querySelector(".interactive-input", function (e) {
            var t = !0, n = !1, i = void 0;
            try {
                for (var a, r = function () {
                    var e = a.value, n = e.querySelector("input"), t = e.querySelector(".interactive-input-action");
                    if (n) {
                        var i = function e(t) {
    ...
    }, {"../utils/core": 69}], 58: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins");
        i.createAccordion({
            triggerSelector: ".accordion-trigger",
    ...
    }, {"../utils/plugins": 72}], 59: [function (e, t, n) {
        "use strict";
        ...
        var o = e("../utils/plugins"), i = e("../utils/core");
        i.querySelector("#engagements-chart", function (e) {
            ...
            o.createChart(t, {
                ...
                options: {
                    ...
                    legend: {display: !1},
                    tooltips: {
                        bodyFontFamily: "'Titillium Web', sans-serif", callbacks: {
                            label: function (e, t) {
            ...
            var t = e[0].getContext("2d"), n = t.createLinearGradient(0, 70, 140, 70);
            ...
            var t = e[0].getContext("2d"), n = t.createLinearGradient(0, 40, 80, 40);
            ...
            var t = [20, 15, 22, 26, 12, 16, 24, 13, 17, 9, 26, 21, 14, 21, 17, 23, 30, 18, 24, 15, 28, 17, 13, 23, 16, 12, 23, 16, 24, 13, 22],
                ...
                i = e[0].getContext("2d"), r = {
                    ...
                    }, {label: "Visits", data: n, maxBarThickness: 16, backgroundColor: "#4ff461"}, {
                        data: function (e, t) {
                            for (var n = new Array(e[0].length).fill(t), i = 0; i < e.length; i++) for (var r = 0; r < e[i].length; r++) n[r] -= e[i][r];
                            return n
                        }([t, n], 55), maxBarThickness: 16, backgroundColor: "#2f3749"
                    }]
                };
            o.createChart(i, {
                type: "bar",
            ...
            var t = e[0].getContext("2d"), n = {
                ...
                datasets: [{
                    ...
                    maxBarThickness: 16,
                    backgroundColor: "#7750f8"
                }, {label: "Sales", data: [120, 25, 130, 110], maxBarThickness: 16, backgroundColor: "#4ff461"}]
            };
            o.createChart(t, {
                type: "bar",
                data: n,
    ...
    }, {"../utils/core": 69, "../utils/plugins": 72}], 60: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/core": 69}], 62: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins"), r = e("../utils/core");
        i.createPopup({
            container: ".popup-video",
            trigger: ".popup-video-trigger",
            sticky: !0,
            overlay: {color: "21, 21, 31", opacity: .96},
            animation: {type: "translate-in-fade", speed: .3, translateOffset: 40}
        }), i.createPopup({
            ...
            var n = e[0], i = n.querySelector(".widget-box-scrollable"), r = n.querySelector(".post-comment-form");
            t(), window.addEventListener("resize", t)
        })
    }, {"../utils/core": 69, "../utils/plugins": 72}], 63: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins");
        i.createTooltip({
            ...
            offset: 4,
            direction: "right",
            animation: {type: "translate-in-fade"}
        }), i.createTooltip({
    ...
    }, {"../utils/plugins": 72}], 64: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins");
        i.createHexagon({
            ...
            lineWidth: 8,
            roundedCorners: !0,
            gradient: {colors: ["#d9ff65", "#40d04f"]},
            scale: {start: 0, end: 1, stop: .74}
        }), i.createHexagon({
    ...
    }, {"../utils/plugins": 72}], 65: [function (e, t, n) {
        "use strict";
        var o = e("../utils/plugins");
        e("../utils/core").querySelector("#search-main", function (e) {
            ...
            var n = o.createDropdown({
                ...
                offset: {top: 57, left: 0},
                animation: {type: "translate-top"},
                controlToggle: !0,
                closeOnWindowClick: !1
            }), i = e[0], r = "", a = i.parentElement.querySelector(".interactive-input-action");
    ...
    }, {"../utils/core": 69, "../utils/plugins": 72}], 66: [function (e, t, n) {
        "use strict";
        var i = e("../utils/plugins");
        i.createProgressBar({
    ...
    }, {"../utils/plugins": 72}], 67: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/plugins": 72}], 68: [function (e, t, n) {
        "use strict";
        var r = e("../utils/core");
        r.querySelector(".content-grid", function (o) {
            ...
            l(), window.addEventListener("resize", l), window.setTimeout(function () {
                ...
                var n = e[0], p = n.querySelector(".chat-widget-messages"), v = n.querySelector(".chat-widget-form"),
                    m = n.querySelector(".chat-widget-button"), i = "closed";
                m.addEventListener("click", function () {
                    ...
                    var i = e[0], r = p.querySelectorAll(".chat-widget-message"),
                        a = i.querySelector(".chat-widget-header"), o = i.querySelector(".chat-widget-conversation"),
                        s = i.querySelector(".chat-widget-close-button"), l = !0, c = !1, d = void 0;
                    try {
                ...
                var n = e[0], i = document.querySelector("#navigation-widget"),
                    r = document.querySelector("#navigation-widget-small"), a = "hidden";
                n.addEventListener("click", function () {
                ...
                var t = e[0], n = document.querySelector("#navigation-widget-mobile"),
                    i = n.querySelector(".navigation-widget-close-button"), r = document.createElement("div");
    ...
    }, {"../utils/core": 69}], 69: [function (e, t, n) {
        "use strict";
        ...
        var r = {
            deepExtend: function (e, t) {
                ...
                var t = e.querySelector("img"), n = t.getAttribute("src");
                ...
                var n = 1 < arguments.length && void 0 !== t ? t : new Date, i = Math.abs(e.getTime() - n.getTime()),
                    r = Math.ceil(i / 1e3), a = Math.floor(i / 6e4), o = Math.floor(i / 36e5),
                    s = Math.floor(i / 864e5), l = Math.floor(i / 6048e5), c = Math.floor(i / 24192e5),
                ...
                return r < 60 ? {
                    ...
                    value: a
                } : o < 24 ? {unit: 1 === o ? "hour" : "hours", value: o} : s < 7 ? {
                    unit: 1 === s ? "day" : "days",
                    value: s
                } : l < 4 ? {unit: 1 === l ? "week" : "weeks", value: l} : c < 12 ? {
        ...
        e("./core").querySelector(".icon-demo-list", function (e) {
            function t(e) {
                var t = document.createElement("div"), n = document.createElement("div"), i = function (e) {
                    ...
                    }(e.className), r = document.createElement("p"), a = document.createElement("p"),
                    o = document.createElement("p"), s = document.createElement("span"),
            ...
            var n = [{name: "Facebook", className: "facebook"}, {
                    name: "Twitter",
                    className: "twitter"
                }, {name: "Twitch", className: "twitch"}, {name: "Youtube", className: "youtube"}, {
                    name: "Instagram",
                    className: "instagram"
                }, {name: "Discord", className: "discord"}, {name: "Patreon", className: "patreon"}, {
                    name: "Google",
                    className: "google"
                    ...
                    name: "Cross",
                    className: "cross"
                }, {name: "Logo Vikinger", className: "logo-vikinger"}, {name: "Grid", className: "grid"}, {
                    name: "Dots",
                    className: "dots"
                }, {name: "Magnifying Glass", className: "magnifying-glass"}, {
                    name: "Comment",
                    className: "comment"
                }, {name: "Thumbs Up", className: "thumbs-up"}, {name: "Friend", className: "friend"}, {
                    name: "Group",
                    className: "group"
                    ...
                    name: "Newsfeed",
                    className: "newsfeed"
                }, {name: "Overview", className: "overview"}, {name: "Members", className: "members"}, {
                    name: "Badges",
                    className: "badges"
                }, {name: "Quests", className: "quests"}, {name: "Streams", className: "streams"}, {
                    name: "Events",
                    className: "events"
                }, {name: "Forums", className: "forums"}, {
                    name: "Small Arrow",
                    className: "small-arrow"
                }, {name: "Big Arrow", className: "big-arrow"}, {name: "Public", className: "public"}, {
                    name: "Private",
                    className: "private"
                }, {name: "Join Group", className: "join-group"}, {
                    name: "Leave Group",
                    className: "leave-group"
                }, {name: "More Dots", className: "more-dots"}, {name: "Profile", className: "profile"}, {
                    name: "Timeline",
                    className: "timeline"
                }, {name: "Photos", className: "photos"}, {name: "Videos", className: "videos"}, {
                    name: "Blog Posts",
                    className: "blog-posts"
                }, {name: "Forum", className: "forum"}, {name: "Store", className: "store"}, {
                    name: "Star",
                    className: "star"
                }, {name: "Play", className: "play"}, {name: "Share", className: "share"}, {
                    name: "Pinned",
                    className: "pinned"
                ...
                }, {name: "Plus", className: "plus"}, {name: "Plus Small", className: "plus-small"}, {
                    name: "Minus Small",
                    className: "minus-small"
                }, {name: "Poll", className: "poll"}, {name: "Camera", className: "camera"}, {
                    name: "Gif",
                    className: "gif"
                }, {name: "Tags", className: "tags"}, {name: "Quote", className: "quote"}, {
                    name: "Pin",
                    className: "pin"
                ...
                }, {name: "Info", className: "info"}, {name: "Check", className: "check"}, {
                    name: "Trophy",
                    className: "trophy"
                }, {name: "Clock", className: "clock"}, {name: "Return", className: "return"}, {
                    name: "Dribbble",
                    className: "dribbble"
                }, {name: "Item", className: "item"}, {name: "Wallet", className: "wallet"}, {
                    name: "Earnings",
                    className: "earnings"
                }, {name: "Revenue", className: "revenue"}, {name: "Login", className: "login"}], i = !0, r = !1,
                a = void 0;
            try {
                for (var o, s = e[Symbol.iterator](); !(i = (o = s.next()).done); i = !0) {
                    var l = o.value, c = n.sort(function (e, t) {
    ...
    }, {"../utils/core": 69}], 72: [function (e, t, n) {
        "use strict";
        ...
        var r = e("tiny-slider/src/tiny-slider"), a = e("chart.html"), o = {
        ...
        t.exports = o
    }, {"chart.js": 1, "tiny-slider/src/tiny-slider": 47}], 73: [function (e, t, n) {
        "use strict";
        ...
        h.querySelector(".tweet-feed", function (s) {
            function l(e) {
                var t = document.createElement("div"), n = document.createElement("a"),
                    i = document.createElement("figure"), r = document.createElement("img"),
                    a = document.createElement("p"), o = document.createElement("p"), s = document.createElement("a"),
                ...
                var c = "https://twitter.com/".concat(e.user.screen_name),
                    d = e.entities.urls.length ? e.entities.urls[0].url : c, u = h.dateDiff(new Date(e.created_at));
            ...
            h.query({url: "includes/getTweets.php?screen_name=odindesign_tw&count=3"}).then(function (e) {
                var t = JSON.parse(e), n = !0, i = !1, r = void 0;
                try {
